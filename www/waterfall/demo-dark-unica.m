...
- (void)viewDidLoad {
    ...
    series.dataLabels.formatter = [[HIFunction alloc] initWithJSFunction:@"function () { return Highcharts.numberFormat(this.y / 1000, 0, ',') + 'k'; }"];
    series.dataLabels.style = [[HICSSObject alloc] init];
