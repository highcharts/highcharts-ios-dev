...
- (void)viewDidLoad {
    ...
    plotoptions.networkgraph = [[HINetworkgraph alloc] init];
    plotoptions.networkgraph.keys = [NSArray arrayWithObjects:@"from", @"to", nil];
    plotoptions.networkgraph.layoutAlgorithm = [[HILayoutAlgorithm alloc] init];
    plotoptions.networkgraph.layoutAlgorithm.enableSimulation = [[NSNumber alloc] initWithBool:true];
    
    HINetworkgraph *networkgraph = [[HINetworkgraph alloc] init];
    networkgraph.dataLabels = [[HIDataLabels alloc] init];
    networkgraph.dataLabels.enabled = [[NSNumber alloc] initWithBool:true];
    
    networkgraph.data = [NSMutableArray arrayWithObjects:@[@"Proto Indo-European", @"Balto-Slavic"],
    ...
    options.series = [NSMutableArray arrayWithObjects:networkgraph, nil];
