...
- (void)viewDidLoad {
    ...
    chart.type = @"area";
    chart.zoomType = @"x";
    chart.panning = [[NSNumber alloc] initWithBool:true];
    chart.panKey = @"shift";
    ...
    HIAnnotations *annotations1 = [[HIAnnotations alloc] init];
    annotations1.labelOptions = [[HILabelOptions alloc] init];
    annotations1.labelOptions.backgroundColor = [[HIColor alloc] initWithRGBA:255 green:255 blue:255 alpha:.5];
    annotations1.labelOptions.verticalAlign = @"top";
    annotations1.labelOptions.y = @15;
    
    HILabels *labels1 = [[HILabels alloc] init];
    labels1.point = [[HIPoint alloc] init];
    ...
    HILabels *labels2 = [[HILabels alloc] init];
    labels2.point = [[HIPoint alloc] init];
    ...
    HILabels *labels3 = [[HILabels alloc] init];
    labels3.point = [[HIPoint alloc] init];
    ...
    HILabels *labels4 = [[HILabels alloc] init];
    labels4.point = [[HIPoint alloc] init];
    ...
    HILabels *labels5 = [[HILabels alloc] init];
    labels5.point = [[HIPoint alloc] init];
    ...
    HILabels *labels6 = [[HILabels alloc] init];
    labels6.point = [[HIPoint alloc] init];
    ...
    annotations1.labels = [NSMutableArray arrayWithObjects:labels1, labels2, labels3, labels4, labels5, labels6, nil];
    
    HIAnnotations *annotations2 = [[HIAnnotations alloc] init];
    
    HILabels *labels7 = [[HILabels alloc] init];
    labels7.point = [[HIPoint alloc] init];
    ...
    HILabels *labels8 = [[HILabels alloc] init];
    labels8.point = [[HIPoint alloc] init];
    ...
    HILabels *labels9 = [[HILabels alloc] init];
    labels9.point = [[HIPoint alloc] init];
    ...
    annotations2.labels = [NSMutableArray arrayWithObjects:labels7, labels8, labels9, nil];
    
    HIAnnotations *annotations3 = [[HIAnnotations alloc] init];
    annotations3.labelOptions = [[HILabelOptions alloc] init];
    ...
    HILabels *labels11 = [[HILabels alloc] init];
    labels11.point = [[HIPoint alloc] init];
    ...
    HILabels *labels12 = [[HILabels alloc] init];
    labels12.point = [[HIPoint alloc] init];
    ...
    annotations3.labels = [NSMutableArray arrayWithObjects:labels10, labels11, labels12, nil];
    ...
    yaxis.startOnTick = [[NSNumber alloc] initWithBool:true];
    ...
    tooltip.shared = [[NSNumber alloc] initWithBool:false];
    
    HILegend *legend = [[HILegend alloc] init];
    legend.enabled = [[NSNumber alloc] initWithBool:false];
    
    HIArea *area = [[HIArea alloc] init];
    area.data = [self elevationData];
    area.lineColor = [[HIColor alloc] initWithHexValue:@"0d233a"];
    area.color = [[HIColor alloc] initWithHexValue:@"8bbc21"];
    area.fillOpacity = @0.5;
    area.name = @"Elevation";
    area.marker = [[HIMarker alloc] init];
    area.marker.enabled = [[NSNumber alloc] initWithBool:false];
    
    options.chart = chart;
    options.title = title;
    options.subtitle = subtitle;
    options.annotations = [NSMutableArray arrayWithObjects:annotations1, annotations2, annotations3, nil];
