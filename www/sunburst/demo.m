...
- (void)viewDidLoad {
    ...
    levels1.level = @2;
    levels1.dataLabels = @{@"rotationMode": @"parallel"};
    
    HILevels *levels2 = [[HILevels alloc] init];
    levels2.level = @3;
    levels2.colorVariation = [[HIColorVariation alloc] init];
    levels2.colorVariation.key = @"brightness";
    levels2.colorVariation.to = @-0.5;
    
    HILevels *levels3 = [[HILevels alloc] init];
    levels3.level = @4;
    levels3.colorVariation = [[HIColorVariation alloc] init];
    levels3.colorVariation.key = @"brightness";
    levels3.colorVariation.to = @0.5;
    
    sunburst.levels = [NSMutableArray arrayWithObjects:levels1, levels2, levels3, nil];
    ...
    options.series = [NSMutableArray arrayWithObjects:sunburst, nil];
