...
- (void)viewDidLoad {
    ...
    pie1.dataLabels.formatter = [[HIFunction alloc] initWithJSFunction:@"function () { return this.y > 5 ? this.point.name : null; }"];
    ...
    pie2.dataLabels.formatter = [[HIFunction alloc] initWithJSFunction:@"function () { /* display only if larger than 1 */ return this.y > 1 ? '<b>' + this.point.name + ':</b> ' + this.y + '%' : null; }"];
