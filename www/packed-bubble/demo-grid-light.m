...
- (void)viewDidLoad {
    ...
    tooltip.pointFormat = @"<b>{point.name}:</b> {point.y}m CO<sub>2</sub>";
    
    HIPlotOptions *plotoptions = [[HIPlotOptions alloc]init];
    plotoptions.packedbubble = [[HIPackedbubble alloc] init];
    plotoptions.packedbubble.dataLabels = [[HIDataLabels alloc] init];
    plotoptions.packedbubble.dataLabels.enabled = [[NSNumber alloc] initWithBool:true];
    plotoptions.packedbubble.dataLabels.format = @"{point.name}";
    plotoptions.packedbubble.dataLabels.filter = [[HIFilter alloc] init];
    plotoptions.packedbubble.dataLabels.filter.property = @"y";
    plotoptions.packedbubble.dataLabels.filter.operator = @">";
    plotoptions.packedbubble.dataLabels.filter.value = @250;
    plotoptions.packedbubble.dataLabels.style = [[HICSSObject alloc] init];
    plotoptions.packedbubble.dataLabels.style.color = @"black";
    plotoptions.packedbubble.dataLabels.style.textOutline = @"none";
    plotoptions.packedbubble.dataLabels.style.fontWeight = @"normal";
    ...
    HIRules *rule = [[HIRules alloc] init];
    rule.condition = [[HICondition alloc] init];
    ...
    responsive.rules = [NSArray arrayWithObjects:rule, nil];
