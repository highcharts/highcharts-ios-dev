...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    plotOptions.scatter.marker.states.hover.lineColor = HIColor(name: "rgb(100,100,100)")
    plotOptions.scatter.states = HIStates()
    plotOptions.scatter.states.hover = HIHover()
    // plotOptions.scatter.states.hover.marker = HIMarker()
    // plotOptions.scatter.states.hover.marker.enabled = true
    ...
    let female = HIScatter()
    female.name = "Female"
    female.color = HIColor(name: "rgba(223, 83, 83, .5)")
    female.data = [[161.2, 51.6], [167.5, 59.0], [159.5, 49.2], [157.0, 63.0], [155.8, 53.6],
    ...
    let male = HIScatter()
    male.name = "Male"
    male.color = HIColor(name: "rgba(119, 152, 191, .5)")
    male.data = [[174.0, 65.6], [175.3, 71.8], [193.5, 80.7], [186.5, 72.6], [187.2, 78.8],
