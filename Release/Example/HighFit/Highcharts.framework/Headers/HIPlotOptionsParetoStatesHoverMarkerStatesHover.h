...
*/
@interface HIPlotOptionsParetoStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsParetoStatesHoverMarkerStatesHoverAnimation *animation;
/**
