...
*/
@interface HIPlotOptionsPyramidStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPyramidStatesHoverMarkerStatesHoverAnimation *animation;
