...
*/
@interface HIAreaStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIAreaStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIAreaStatesHoverHalo *halo;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIAreaStatesHoverAnimation *animation;
