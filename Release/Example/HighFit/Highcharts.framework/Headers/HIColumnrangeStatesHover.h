...
*/
@interface HIColumnrangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIColumnrangeStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIColumnrangeStatesHoverMarker *marker;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIColumnrangeStatesHoverAnimation *animation;
