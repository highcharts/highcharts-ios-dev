...
*/
@interface HIPlotOptionsPyramidTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPyramidTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
