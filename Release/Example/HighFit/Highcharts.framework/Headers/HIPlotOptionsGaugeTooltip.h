...
*/
@interface HIPlotOptionsGaugeTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
