...
*/
@interface HIAreasplineStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIAreasplineStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIAreasplineStatesHoverHalo *halo;
/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIAreasplineStatesHoverAnimation *animation;
