...
*/
@interface HIPlotOptionsAreasplineTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplineTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
