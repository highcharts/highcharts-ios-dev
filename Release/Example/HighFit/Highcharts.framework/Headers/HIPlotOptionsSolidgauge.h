...
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsSolidgaugeStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeLabel *label;
/**
