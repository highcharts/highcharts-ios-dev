...
*/
@interface HIVariablepieStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIVariablepieStatesHoverMarkerStatesHoverAnimation *animation;
/**
