...
*/
@interface HIColumnStatesHover: HIChartsJSONSerializable

/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIColumnStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIColumnStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIColumnStatesHoverHalo *halo;
