...
*/
@property(nonatomic, readwrite) NSArray <HIHeatmapZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIHeatmapLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIHeatmapAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIHeatmapStates *> *states;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIHeatmapMarker *marker;
/**
