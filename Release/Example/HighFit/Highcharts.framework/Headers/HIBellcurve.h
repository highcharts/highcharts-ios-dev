...
*/
@property(nonatomic, readwrite) HIBellcurveTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIBellcurveLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIBellcurveStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIBellcurveZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIBellcurvePoint *point;
/**
...
function.
*/
@property(nonatomic, readwrite) HIBellcurveEvents *events;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIBellcurveMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIBellcurveAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIBellcurveDataLabels *dataLabels;
/**
