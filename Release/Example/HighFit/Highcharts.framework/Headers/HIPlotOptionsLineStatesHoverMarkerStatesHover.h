...
*/
@interface HIPlotOptionsLineStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsLineStatesHoverMarkerStatesHoverAnimation *animation;
/**
