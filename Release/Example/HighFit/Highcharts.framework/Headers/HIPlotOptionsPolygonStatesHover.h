...
*/
@interface HIPlotOptionsPolygonStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonStatesHoverMarker *marker;
/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonStatesHoverAnimation *animation;
/**
