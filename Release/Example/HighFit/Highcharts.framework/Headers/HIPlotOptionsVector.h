...
*/
@interface HIPlotOptionsVector: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVectorDataLabels *dataLabels;
/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsVectorStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsVectorZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVectorPoint *point;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVectorAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVectorTooltip *tooltip;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsVectorEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVectorLabel *label;
/**
