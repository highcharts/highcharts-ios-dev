...
*/
@interface HIPlotOptionsSeriesStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSeriesStatesHoverMarkerStatesHoverAnimation *animation;
