...
*/
@interface HIPlotOptionsArearange: HIChartsJSONSerializable
...
sets individually.
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsArearangeStates *> *states;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsArearangeZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangePoint *point;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeMarker *marker;
/**
