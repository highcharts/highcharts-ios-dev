...
*/
@interface HIPlotOptionsAreasplinerangeStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeStatesHoverMarkerStatesHoverAnimation *animation;
/**
