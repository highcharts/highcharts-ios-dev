...
*/
@property(nonatomic, readwrite) HITreemapDrillUpButton *drillUpButton;
/**
...
*/
@property(nonatomic, readwrite) HITreemapLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HITreemapStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HITreemapAnimation *animation;
/**
...
class names.
*/
@property(nonatomic, readwrite) HITreemapMarker *marker;
/**
