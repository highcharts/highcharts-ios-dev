...
*/
@interface HIWindbarbStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIWindbarbStatesHoverMarkerStatesHoverAnimation *animation;
/**
