...
*/
@interface HIPlotOptionsSankeyTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSankeyTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
