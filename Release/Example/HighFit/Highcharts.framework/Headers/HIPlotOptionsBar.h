...
*/
@interface HIPlotOptionsBar: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBarLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsBarStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBarPoint *point;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsBarEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBarDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsBarZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBarTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBarAnimation *animation;
/**
