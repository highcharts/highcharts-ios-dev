...
*/
@interface HISolidgaugeStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HISolidgaugeStatesHoverMarkerStatesHoverAnimation *animation;
/**
