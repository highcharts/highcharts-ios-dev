...
*/
@interface HIPlotOptionsScatterMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterMarkerStatesHoverAnimation *animation;
/**
