...
/**
* description: A bar series. If the type option is not specified,
...
*/
@property(nonatomic, readwrite) HIBarAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIBarLabel *label;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIBarMarker *marker;
/**
