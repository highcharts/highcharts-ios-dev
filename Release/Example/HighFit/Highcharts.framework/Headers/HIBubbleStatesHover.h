...
*/
@interface HIBubbleStatesHover: HIChartsJSONSerializable

/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIBubbleStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIBubbleStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIBubbleStatesHoverMarker *marker;
/**
