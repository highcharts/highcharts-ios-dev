...
*/
@interface HIPlotOptionsScatter3dMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dMarkerStatesHoverAnimation *animation;
