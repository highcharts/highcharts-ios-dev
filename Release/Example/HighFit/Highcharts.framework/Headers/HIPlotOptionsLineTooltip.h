...
*/
@interface HIPlotOptionsLineTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsLineTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
