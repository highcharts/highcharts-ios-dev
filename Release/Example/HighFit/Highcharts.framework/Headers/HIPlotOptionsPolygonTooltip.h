...
*/
@interface HIPlotOptionsPolygonTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
