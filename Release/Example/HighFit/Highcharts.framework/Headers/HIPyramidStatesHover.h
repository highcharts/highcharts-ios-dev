...
*/
@interface HIPyramidStatesHover: HIChartsJSONSerializable

/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPyramidStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPyramidStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIPyramidStatesHoverMarker *marker;
