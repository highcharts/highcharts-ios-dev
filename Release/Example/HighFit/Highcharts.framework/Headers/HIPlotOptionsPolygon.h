...
*/
@interface HIPlotOptionsPolygon: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsPolygonZones *> *zones;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsPolygonStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonPoint *point;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonAnimation *animation;
