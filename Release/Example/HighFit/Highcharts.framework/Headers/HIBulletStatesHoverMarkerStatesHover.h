...
*/
@interface HIBulletStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIBulletStatesHoverMarkerStatesHoverAnimation *animation;
/**
