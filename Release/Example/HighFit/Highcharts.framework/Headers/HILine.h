...
/**
* description: A line series. If the type option is not
...
*/
@property(nonatomic, readwrite) HILineAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HILineLabel *label;
/**
