...
*/
@interface HIPlotOptionsPyramidStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPyramidStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPyramidStatesHoverHalo *halo;
/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsPyramidStatesHoverAnimation *animation;
/**
