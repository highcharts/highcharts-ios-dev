...
*/
@interface HIHistogramStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIHistogramStatesHoverMarker *marker;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIHistogramStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIHistogramStatesHoverHalo *halo;
/**
