...
*/
@interface HIScatterStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIScatterStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIScatterStatesHoverMarker *marker;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIScatterStatesHoverAnimation *animation;
