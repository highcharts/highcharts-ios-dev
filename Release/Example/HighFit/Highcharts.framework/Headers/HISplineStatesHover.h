...
*/
@interface HISplineStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HISplineStatesHoverHalo *halo;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HISplineStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HISplineStatesHoverMarker *marker;
