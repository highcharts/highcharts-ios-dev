...
*/
@interface HIWaterfallStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIWaterfallStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIWaterfallStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIWaterfallStatesHoverMarker *marker;
/**
