...
* demo: https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/gauge-activity/ : Rounded gauge
...
*/
@property(nonatomic, readwrite) HISolidgaugeLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HISolidgaugeZones *> *zones;
/**
...
* demo: https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/solidgauge-threshold/ : Zero threshold with negative and positive values
* default: null
*/
...
*/
@property(nonatomic, readwrite) HISolidgaugeAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HISolidgaugeStates *> *states;
/**
...
class names.
*/
@property(nonatomic, readwrite) HISolidgaugeMarker *marker;
