...
*/
@interface HIPlotOptionsGauge: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeAnimation *animation;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugePoint *point;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeDial *dial;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeDataLabels *dataLabels;
/**
...
* demo: https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/gauge/ : Styled mode
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugePivot *pivot;
/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsGaugeStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeTooltip *tooltip;
/**
