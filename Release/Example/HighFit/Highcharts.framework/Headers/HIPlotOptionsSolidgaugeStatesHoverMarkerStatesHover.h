...
*/
@interface HIPlotOptionsSolidgaugeStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeStatesHoverMarkerStatesHoverAnimation *animation;
/**
