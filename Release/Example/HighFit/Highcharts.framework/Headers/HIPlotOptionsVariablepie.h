...
*/
@interface HIPlotOptionsVariablepie: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieLabel *label;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepiePoint *point;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieDataLabels *dataLabels;
/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsVariablepieStates *> *states;
/**
