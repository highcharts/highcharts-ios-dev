...
*/
@interface HIStreamgraphStatesHover: HIChartsJSONSerializable

/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIStreamgraphStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIStreamgraphStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIStreamgraphStatesHoverMarker *marker;
