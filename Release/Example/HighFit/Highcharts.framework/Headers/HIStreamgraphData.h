...
*/
@interface HIStreamgraphData: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIStreamgraphDataEvents *events;
/**
...
@property(nonatomic, readwrite) HIStreamgraphDataMarker *marker;
/**
