...
*/
@interface HIErrorbarStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIErrorbarStatesHoverMarkerStatesHoverAnimation *animation;
/**
