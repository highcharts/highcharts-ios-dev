...
*/
@interface HIPlotOptionsPolygonMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonMarkerStatesHoverAnimation *animation;
/**
