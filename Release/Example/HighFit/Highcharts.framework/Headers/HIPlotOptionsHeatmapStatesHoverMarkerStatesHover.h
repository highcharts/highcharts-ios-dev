...
*/
@interface HIPlotOptionsHeatmapStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHeatmapStatesHoverMarkerStatesHoverAnimation *animation;
/**
