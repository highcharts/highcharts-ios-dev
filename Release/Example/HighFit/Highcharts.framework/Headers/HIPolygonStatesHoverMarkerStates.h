...
*/
@interface HIPolygonStatesHoverMarkerStates: HIChartsJSONSerializable
...
option to true.
*/
@property(nonatomic, readwrite) HIPolygonStatesHoverMarkerStatesSelect *select;
/**
* description: The hover state for a single point marker.
*/
@property(nonatomic, readwrite) HIPolygonStatesHoverMarkerStatesHover *hover;
