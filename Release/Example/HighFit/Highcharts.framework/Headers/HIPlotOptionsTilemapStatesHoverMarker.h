...
*/
@interface HIPlotOptionsTilemapStatesHoverMarker: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapStatesHoverMarkerStates *states;
/**
