...
*/
@interface HIPlotOptionsColumnrangeTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangeTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
