...
sets individually.
*/
@interface HIPlotOptionsColumnrangeDataLabels: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangeDataLabelsStyle *style;
/**
...
https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/arearange-datalabels/ : Data labels on range series
* default: 0
*/
