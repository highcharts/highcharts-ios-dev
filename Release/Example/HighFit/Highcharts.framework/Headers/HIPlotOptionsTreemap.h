...
*/
@interface HIPlotOptionsTreemap: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapDrillUpButton *drillUpButton;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsTreemapLevels *> *levels;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsTreemapStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapPoint *point;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsTreemapZones *> *zones;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapEvents *events;
/**
