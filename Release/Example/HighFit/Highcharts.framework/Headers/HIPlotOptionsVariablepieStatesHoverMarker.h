...
*/
@interface HIPlotOptionsVariablepieStatesHoverMarker: HIChartsJSONSerializable

/**
* description: States for a single point marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieStatesHoverMarkerStates *states;
/**
