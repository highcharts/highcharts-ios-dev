...
*/
@interface HIPlotOptionsHeatmapStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsHeatmapStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHeatmapStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHeatmapStatesHoverHalo *halo;
