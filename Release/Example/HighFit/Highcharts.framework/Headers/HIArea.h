...
/**
* description: A area series. If the type option is not
...
*/
@property(nonatomic, readwrite) HIAreaLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIAreaAnimation *animation;
/**
