...
*/
@interface HIAreasplinerangeStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIAreasplinerangeStatesHoverMarkerStatesHoverAnimation *animation;
/**
