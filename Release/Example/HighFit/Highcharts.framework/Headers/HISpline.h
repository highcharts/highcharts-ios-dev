...
/**
* description: A spline series. If the type option is
...
class names.
*/
@property(nonatomic, readwrite) HISplineMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HISplineZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HISplinePoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HISplineStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HISplineDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HISplineLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HISplineTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HISplineAnimation *animation;
/**
