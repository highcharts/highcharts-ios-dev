...
*/
@interface HIPlotOptionsTreemapTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
