...
*/
@interface HIArearangeStatesHover: HIChartsJSONSerializable

/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIArearangeStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIArearangeStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIArearangeStatesHoverHalo *halo;
/**
