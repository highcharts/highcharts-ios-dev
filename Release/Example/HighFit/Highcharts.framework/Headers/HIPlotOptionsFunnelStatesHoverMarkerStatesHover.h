...
*/
@interface HIPlotOptionsFunnelStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsFunnelStatesHoverMarkerStatesHoverAnimation *animation;
/**
