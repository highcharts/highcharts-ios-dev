...
*/
@interface HIPlotOptionsTilemapStatesHoverHalo: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapStatesHoverHaloAttributes *attributes;
