...
*/
@interface HIPlotOptionsStreamgraphStatesHoverMarker: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsStreamgraphStatesHoverMarkerStates *states;
/**
