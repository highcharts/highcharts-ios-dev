...
*/
@property(nonatomic, readwrite) HIGaugeAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIGaugeStates *> *states;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIGaugeMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIGaugeLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIGaugeZones *> *zones;
/**
