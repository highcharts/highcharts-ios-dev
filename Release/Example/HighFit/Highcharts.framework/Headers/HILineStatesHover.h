...
*/
@interface HILineStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HILineStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HILineStatesHoverHalo *halo;
/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HILineStatesHoverAnimation *animation;
/**
