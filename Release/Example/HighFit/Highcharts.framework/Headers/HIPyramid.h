...
class names.
*/
@property(nonatomic, readwrite) HIPyramidMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPyramidLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIPyramidAnimation *animation;
/**
