...
*/
@interface HIPlotOptionsBulletTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBulletTooltipDateTimeLabelFormats *dateTimeLabelFormats;
