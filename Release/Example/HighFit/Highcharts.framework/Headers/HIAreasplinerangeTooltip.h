...
*/
@interface HIAreasplinerangeTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIAreasplinerangeTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
