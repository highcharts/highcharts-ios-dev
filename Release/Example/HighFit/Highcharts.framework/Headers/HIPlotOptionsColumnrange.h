...
*/
@interface HIPlotOptionsColumnrange: HIChartsJSONSerializable
...
@property(nonatomic, readwrite) id marker;
/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsColumnrangeStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsColumnrangeZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangeAnimation *animation;
/**
...
sets individually.
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangeDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangePoint *point;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangeTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangeLabel *label;
/**
