...
*/
@interface HIColumnrangeStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIColumnrangeStatesHoverMarkerStatesHoverAnimation *animation;
/**
