...
*/
@interface HIPlotOptionsSolidgaugeTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
