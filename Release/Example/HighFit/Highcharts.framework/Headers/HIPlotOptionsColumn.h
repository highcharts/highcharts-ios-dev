...
*/
@interface HIPlotOptionsColumn: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsColumnZones *> *zones;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnEvents *events;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsColumnStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnPoint *point;
/**
