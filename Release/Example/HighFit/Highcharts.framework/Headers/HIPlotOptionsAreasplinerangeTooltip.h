...
*/
@interface HIPlotOptionsAreasplinerangeTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
