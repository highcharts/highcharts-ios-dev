...
*/
@interface HIPlotOptionsArearangeStatesHoverMarker: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeStatesHoverMarkerStates *states;
/**
