...
*/
@interface HIBarDataLabels: HIChartsJSONSerializable
...
* demo: https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/bar-datalabels-align-inside-bar/ : Data labels inside the bar
...
*/
@property(nonatomic, readwrite) HIBarDataLabelsStyle *style;
/**
