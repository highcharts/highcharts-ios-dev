...
*/
@interface HIBellcurveStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIBellcurveStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIBellcurveStatesHoverHalo *halo;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIBellcurveStatesHoverAnimation *animation;
