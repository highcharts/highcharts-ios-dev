...
*/
@interface HIPlotOptionsSpline: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsSplineZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineAnimation *animation;
/**
* description: Properties for each single point.
*/
@property(nonatomic, readwrite) HIPlotOptionsSplinePoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsSplineStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineTooltip *tooltip;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineEvents *events;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineLabel *label;
/**
