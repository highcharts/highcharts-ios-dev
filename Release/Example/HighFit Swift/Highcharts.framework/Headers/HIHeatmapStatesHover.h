...
*/
@interface HIHeatmapStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIHeatmapStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIHeatmapStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIHeatmapStatesHoverHalo *halo;
/**
