...
*/
@interface HIPlotOptionsStreamgraphMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsStreamgraphMarkerStatesHoverAnimation *animation;
/**
