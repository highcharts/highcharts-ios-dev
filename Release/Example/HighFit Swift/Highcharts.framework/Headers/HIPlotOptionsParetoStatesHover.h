...
*/
@interface HIPlotOptionsParetoStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsParetoStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsParetoStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsParetoStatesHoverMarker *marker;
/**
