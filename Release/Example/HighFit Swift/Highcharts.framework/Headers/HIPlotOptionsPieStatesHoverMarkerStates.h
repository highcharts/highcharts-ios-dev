...
*/
@interface HIPlotOptionsPieStatesHoverMarkerStates: HIChartsJSONSerializable
...
option to true.
*/
@property(nonatomic, readwrite) HIPlotOptionsPieStatesHoverMarkerStatesSelect *select;
/**
* description: The hover state for a single point marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsPieStatesHoverMarkerStatesHover *hover;
