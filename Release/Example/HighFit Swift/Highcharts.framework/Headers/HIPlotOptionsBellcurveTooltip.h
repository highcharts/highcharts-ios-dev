...
*/
@interface HIPlotOptionsBellcurveTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBellcurveTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
