...
*/
@interface HIPlotOptionsScatter3d: HIChartsJSONSerializable
...
class names.
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsScatter3dStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsScatter3dZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dDataLabels *dataLabels;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dEvents *events;
/**
* description: Properties for each single point.
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dPoint *point;
/**
