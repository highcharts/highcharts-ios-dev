...
*/
@interface HIChartParallelAxes: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIChartParallelAxesDateTimeLabelFormats *dateTimeLabelFormats;
/**
...
*/
@property(nonatomic, readwrite) HIChartParallelAxesEvents *events;
/**
...
* default: false
*/
@property(nonatomic, readwrite) HIChartParallelAxesCrosshair *crosshair;
/**
...
*/
@property(nonatomic, readwrite) HIChartParallelAxesLabels *labels;
/**
