...
*/
@interface HIWindbarbData: HIChartsJSONSerializable
...
@property(nonatomic, readwrite) HIWindbarbDataMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIWindbarbDataEvents *events;
