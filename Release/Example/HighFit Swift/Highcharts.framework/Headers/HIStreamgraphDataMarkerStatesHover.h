...
*/
@interface HIStreamgraphDataMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIStreamgraphDataMarkerStatesHoverAnimation *animation;
/**
