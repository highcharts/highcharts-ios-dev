...
*/
@interface HIPlotOptionsErrorbarTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsErrorbarTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
