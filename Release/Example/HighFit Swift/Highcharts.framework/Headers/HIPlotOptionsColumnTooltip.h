...
*/
@interface HIPlotOptionsColumnTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
