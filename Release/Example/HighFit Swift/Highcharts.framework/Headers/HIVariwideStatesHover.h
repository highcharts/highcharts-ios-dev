...
*/
@interface HIVariwideStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIVariwideStatesHoverHalo *halo;
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIVariwideStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIVariwideStatesHoverMarker *marker;
/**
