...
*/
@interface HIPlotOptionsTreemapStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapStatesHoverMarkerStatesHoverAnimation *animation;
/**
