...
*/
@interface HIPlotOptionsSeriesMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSeriesMarkerStatesHoverAnimation *animation;
/**
