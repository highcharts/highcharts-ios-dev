...
*/
@interface HIPlotOptionsFunnelTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsFunnelTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
