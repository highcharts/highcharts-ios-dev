...
*/
@interface HIPlotOptionsSankeyDataLabels: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSankeyDataLabelsStyle *style;
/**
...
and-string-formatting : format string specifying what to show for links in the 
