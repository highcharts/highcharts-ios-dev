...
*/
@property(nonatomic, readwrite) HIVariwideTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIVariwidePoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIVariwideStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIVariwideLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIVariwideDataLabels *dataLabels;
/**
...
function.
*/
@property(nonatomic, readwrite) HIVariwideEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIVariwideAnimation *animation;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIVariwideMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIVariwideZones *> *zones;
/**
