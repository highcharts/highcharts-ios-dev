...
*/
@interface HIPlotOptionsArearangeStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeStatesHoverMarkerStatesHoverAnimation *animation;
