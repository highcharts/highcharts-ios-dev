...
*/
@interface HIPlotOptionsScatterTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
