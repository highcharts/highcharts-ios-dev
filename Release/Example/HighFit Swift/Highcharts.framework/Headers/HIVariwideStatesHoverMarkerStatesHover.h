...
*/
@interface HIVariwideStatesHoverMarkerStatesHover: HIChartsJSONSerializable

/**
* description: Animation when hovering over the marker.
*/
@property(nonatomic, readwrite) HIVariwideStatesHoverMarkerStatesHoverAnimation *animation;
/**
