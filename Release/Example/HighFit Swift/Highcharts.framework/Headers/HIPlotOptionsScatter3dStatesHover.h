...
*/
@interface HIPlotOptionsScatter3dStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dStatesHoverMarker *marker;
/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dStatesHoverHalo *halo;
/**
