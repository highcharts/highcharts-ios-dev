...
*/
@interface HIPieStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPieStatesHoverHalo *halo;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPieStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPieStatesHoverMarker *marker;
