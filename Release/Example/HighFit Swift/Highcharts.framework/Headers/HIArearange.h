...
*/
@property(nonatomic, readwrite) HIArearangeLabel *label;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIArearangeMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIArearangeAnimation *animation;
/**
