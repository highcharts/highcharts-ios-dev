...
*/
@interface HIPlotOptionsVariablepieStatesHoverMarkerStates: HIChartsJSONSerializable
...
option to true.
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieStatesHoverMarkerStatesSelect *select;
/**
* description: The hover state for a single point marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieStatesHoverMarkerStatesHover *hover;
