...
*/
@interface HIScatter3dStatesHover: HIChartsJSONSerializable

/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIScatter3dStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIScatter3dStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIScatter3dStatesHoverMarker *marker;
