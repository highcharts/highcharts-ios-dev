...
*/
@interface HIPlotOptionsHistogram: HIChartsJSONSerializable
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsHistogramEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHistogramDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHistogramAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsHistogramZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsHistogramStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHistogramTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHistogramPoint *point;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHistogramLabel *label;
/**
