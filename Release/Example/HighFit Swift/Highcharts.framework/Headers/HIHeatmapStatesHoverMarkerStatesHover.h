...
*/
@interface HIHeatmapStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIHeatmapStatesHoverMarkerStatesHoverAnimation *animation;
/**
