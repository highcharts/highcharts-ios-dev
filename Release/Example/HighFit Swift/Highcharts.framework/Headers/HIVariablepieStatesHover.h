...
*/
@interface HIVariablepieStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIVariablepieStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIVariablepieStatesHoverMarker *marker;
/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIVariablepieStatesHoverAnimation *animation;
