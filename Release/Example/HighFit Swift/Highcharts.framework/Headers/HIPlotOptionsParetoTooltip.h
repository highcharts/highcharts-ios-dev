...
*/
@interface HIPlotOptionsParetoTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsParetoTooltipDateTimeLabelFormats *dateTimeLabelFormats;
