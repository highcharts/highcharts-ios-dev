...
*/
@interface HIPlotOptionsAreasplinerangeStatesHoverMarkerStates: HIChartsJSONSerializable
...
option to true.
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeStatesHoverMarkerStatesSelect *select;
/**
* description: The hover state for a single point marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeStatesHoverMarkerStatesHover *hover;
