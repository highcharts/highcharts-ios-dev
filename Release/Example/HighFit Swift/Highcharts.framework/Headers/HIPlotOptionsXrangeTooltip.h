...
*/
@interface HIPlotOptionsXrangeTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsXrangeTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
