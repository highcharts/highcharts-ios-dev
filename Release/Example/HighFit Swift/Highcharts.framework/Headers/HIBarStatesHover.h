...
*/
@interface HIBarStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIBarStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIBarStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIBarStatesHoverMarker *marker;
