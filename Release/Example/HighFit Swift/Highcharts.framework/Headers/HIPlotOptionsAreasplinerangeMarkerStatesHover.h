...
*/
@interface HIPlotOptionsAreasplinerangeMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeMarkerStatesHoverAnimation *animation;
/**
