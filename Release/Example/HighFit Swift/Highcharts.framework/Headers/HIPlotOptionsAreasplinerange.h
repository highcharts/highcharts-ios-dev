...
class names.
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeAnimation *animation;
/**
