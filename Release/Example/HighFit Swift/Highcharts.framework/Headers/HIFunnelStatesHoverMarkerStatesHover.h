...
*/
@interface HIFunnelStatesHoverMarkerStatesHover: HIChartsJSONSerializable

/**
* description: Animation when hovering over the marker.
*/
@property(nonatomic, readwrite) HIFunnelStatesHoverMarkerStatesHoverAnimation *animation;
/**
