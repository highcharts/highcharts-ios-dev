...
*/
@interface HIPolygonStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPolygonStatesHoverMarkerStatesHoverAnimation *animation;
/**
