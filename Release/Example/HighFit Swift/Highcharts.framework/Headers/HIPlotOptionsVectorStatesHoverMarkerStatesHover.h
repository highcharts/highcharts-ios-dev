...
*/
@interface HIPlotOptionsVectorStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVectorStatesHoverMarkerStatesHoverAnimation *animation;
