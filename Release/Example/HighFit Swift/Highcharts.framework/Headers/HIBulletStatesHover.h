...
*/
@interface HIBulletStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIBulletStatesHoverHalo *halo;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIBulletStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIBulletStatesHoverMarker *marker;
