...
*/
@property(nonatomic, readwrite) HIHistogramDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIHistogramZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIHistogramTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIHistogramAnimation *animation;
/**
...
function.
*/
@property(nonatomic, readwrite) HIHistogramEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIHistogramLabel *label;
/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSArray <HIHistogramStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIHistogramPoint *point;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIHistogramMarker *marker;
/**
* description: An integer identifying the index to use for the base series, or a string
representing the id of the series.
* default: undefined
*/
@property(nonatomic, readwrite) id /* NSString, NSNumber */ baseSeries;
/**
