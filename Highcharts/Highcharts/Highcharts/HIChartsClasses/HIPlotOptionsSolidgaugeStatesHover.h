...
*/
@interface HIPlotOptionsSolidgaugeStatesHover: HIChartsJSONSerializable

/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeStatesHoverHalo *halo;
/**
