...
/**
* description: An array of data points for the series. For the <code>areaspline</code> series type, points can be given in the following ways:
 <ol>
...
*/
@interface AreasplineData: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) AreasplineDataEvents *events;
/**
...
@property(nonatomic, readwrite) AreasplineDataMarker *marker;
/**
