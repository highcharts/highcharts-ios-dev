...
*/
@interface HIPlotOptionsPieTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPieTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
