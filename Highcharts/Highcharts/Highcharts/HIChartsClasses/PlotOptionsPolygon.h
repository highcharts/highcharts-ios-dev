...
*/
@interface PlotOptionsPolygon: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsPolygonTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPolygonMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPolygonDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*PlotOptionsPolygonStates*/ *states;
/**
...
@property(nonatomic, readwrite) PlotOptionsPolygonEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPolygonHIPoint *point;
/**
