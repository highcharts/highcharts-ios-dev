...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsColumnStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsColumnZones *> *zones;
/**
