...
*/
@interface HIPlotOptionsStreamgraphTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsStreamgraphTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
