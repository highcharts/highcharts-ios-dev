...
@interface PlotOptionsBarDataLabels: HIChartsJSONSerializable
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/bar-datalabels-align-inside-bar/" target="_blank">Data labels inside the bar</a>
*/
