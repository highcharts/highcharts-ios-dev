...
/**
* description: <p>A <code>gauge</code> series. If the <a href="#series<gauge>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) GaugeHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) GaugePivot *pivot;
/**
...
*/
@property(nonatomic, readwrite) GaugeTooltip *tooltip;
@property(nonatomic, readwrite) GaugeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) GaugeDataLabels *dataLabels;
/**
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/css/gauge/" target="_blank">Styled mode</a>.
*/
@property(nonatomic, readwrite) GaugeDial *dial;
/**
