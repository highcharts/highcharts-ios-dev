...
*/
@interface PlotOptionsBarStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsBarStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsBarStatesHoverMarker *marker;
