...
*/
@interface HIPlotOptionsAreasplinerangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeStatesHoverHalo *halo;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeStatesHoverMarker *marker;
