...
@interface PlotOptionsBar: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsBarHIPoint *point;
/**
...
@property(nonatomic, readwrite) PlotOptionsBarEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsBarTooltip *tooltip;
/**
...
@property(nonatomic, readwrite) PlotOptionsBarDataLabels *dataLabels;
/**
