...
*/
@interface HIPlotOptionsSplineMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineMarkerStatesHoverAnimation *animation;
/**
