...
*/
@interface PlotOptionsPolygonStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsPolygonStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPolygonStatesHoverHalo *halo;
/**
