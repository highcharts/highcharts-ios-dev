...
@interface PlotOptionsColumn: HIChartsJSONSerializable

/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSMutableArray /*PlotOptionsColumnStates*/ *states;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnTooltip *tooltip;
/**
...
@property(nonatomic, readwrite) PlotOptionsColumnEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnHIPoint *point;
/**
