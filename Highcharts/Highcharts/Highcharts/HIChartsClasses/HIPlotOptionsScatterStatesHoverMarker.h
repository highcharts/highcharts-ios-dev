...
*/
@interface HIPlotOptionsScatterStatesHoverMarker: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterStatesHoverMarkerStates *states;
/**
