...
*/
@interface HIPlotOptionsColumnrangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangeStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsColumnrangeStatesHoverMarker *marker;
