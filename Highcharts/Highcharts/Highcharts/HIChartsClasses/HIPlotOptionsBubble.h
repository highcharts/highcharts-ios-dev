...
*/
@interface HIPlotOptionsBubble: HIChartsJSONSerializable
...
@property(nonatomic, readwrite) HIPlotOptionsBubbleEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBubbleMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBubbleTooltip *tooltip;
/**
* description: Properties for each single point
*/
@property(nonatomic, readwrite) HIPlotOptionsBubblePoint *point;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBubbleDataLabels *dataLabels;
/**
