...
*/
@interface HIPlotOptionsSeries: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsSeriesZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSeriesTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSeriesDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) HIPlotOptionsSeriesEvents *events;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsSeriesStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSeriesMarker *marker;
/**
...
* demo: http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/line-step/ : Different step line options. http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/area-step/ : Stepped, stacked area.
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSeriesPoint *point;
/**
