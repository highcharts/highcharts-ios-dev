...
/**
* description: <p>A <code>areasplinerange</code> series. If the <a href="#series<areasplinerange>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@interface Areasplinerange: Series
...
*/
@property(nonatomic, readwrite) NSMutableArray /*AreasplinerangeZones*/ *zones;
/**
...
*/
@property(nonatomic, readwrite) AreasplinerangeHIPoint *point;
/**
...
@property(nonatomic, readwrite) AreasplinerangeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) AreasplinerangeTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) AreasplinerangeDataLabels *dataLabels;
/**
