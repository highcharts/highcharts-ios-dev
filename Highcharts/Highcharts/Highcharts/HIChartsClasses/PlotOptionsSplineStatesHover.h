...
*/
@interface PlotOptionsSplineStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsSplineStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsSplineStatesHoverHalo *halo;
/**
