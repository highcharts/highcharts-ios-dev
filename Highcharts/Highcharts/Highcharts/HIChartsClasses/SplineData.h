...
/**
* description: An array of data points for the series. For the <code>spline</code> series type, points can be given in the following ways:
 <ol>
...
*/
@interface SplineData: HIChartsJSONSerializable
...
@property(nonatomic, readwrite) SplineDataMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) SplineDataEvents *events;
/**
