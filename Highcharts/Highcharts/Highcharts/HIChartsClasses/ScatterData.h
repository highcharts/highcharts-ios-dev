...
/**
* description: An array of data points for the series. For the <code>scatter</code> series type, points can be given in the following ways:
 <ol>
...
*/
@interface ScatterData: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) ScatterDataEvents *events;
@property(nonatomic, readwrite) ScatterDataMarker *marker;
/**
