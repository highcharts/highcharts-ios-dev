...
*/
@interface FunnelStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) FunnelStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) FunnelStatesHoverMarker *marker;
/**
