...
/**
* description: <p>A <code>areaspline</code> series. If the <a href="#series<areaspline>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) AreasplineDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) AreasplineEvents *events;
/**
...
*/
@property(nonatomic, readwrite) AreasplineTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) AreasplineMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) AreasplineHIPoint *point;
/**
