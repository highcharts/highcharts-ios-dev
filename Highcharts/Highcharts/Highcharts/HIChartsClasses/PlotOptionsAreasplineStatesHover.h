...
*/
@interface PlotOptionsAreasplineStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsAreasplineStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsAreasplineStatesHoverHalo *halo;
