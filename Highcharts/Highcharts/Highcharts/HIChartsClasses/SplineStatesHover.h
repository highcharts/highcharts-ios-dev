...
*/
@interface SplineStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) SplineStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) SplineStatesHoverMarker *marker;
