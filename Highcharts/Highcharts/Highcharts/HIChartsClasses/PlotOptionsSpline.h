...
@interface PlotOptionsSpline: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsSplineHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsSplineTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsSplineDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) PlotOptionsSplineEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsSplineMarker *marker;
/**
