...
*/
@interface PlotOptionsPieStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsPieStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPieStatesHoverMarker *marker;
/**
