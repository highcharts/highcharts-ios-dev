...
/**
* description: An array of data points for the series. For the <code>polygon</code> series type, points can be given in the following ways:
 <ol>
...
*/
@interface PolygonData: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PolygonDataEvents *events;
/**
...
@property(nonatomic, readwrite) PolygonDataMarker *marker;
