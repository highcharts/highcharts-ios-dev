...
/**
* description: <p>A <code>spline</code> series. If the <a href="#series<spline>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
@property(nonatomic, readwrite) SplineEvents *events;
/**
...
*/
@property(nonatomic, readwrite) SplineMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) SplineTooltip *tooltip;
/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSMutableArray /*SplineStates*/ *states;
/**
...
*/
@property(nonatomic, readwrite) SplineHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) SplineDataLabels *dataLabels;
/**
