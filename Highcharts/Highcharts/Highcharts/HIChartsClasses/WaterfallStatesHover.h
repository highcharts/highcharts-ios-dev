...
*/
@interface WaterfallStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) WaterfallStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) WaterfallStatesHoverHalo *halo;
/**
