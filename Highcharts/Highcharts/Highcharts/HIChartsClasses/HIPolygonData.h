...
*/
@interface HIPolygonData: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPolygonDataEvents *events;
/**
...
@property(nonatomic, readwrite) HIPolygonDataMarker *marker;
