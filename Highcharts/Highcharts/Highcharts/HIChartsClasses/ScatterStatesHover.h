...
*/
@interface ScatterStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) ScatterStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) ScatterStatesHoverHalo *halo;
/**
