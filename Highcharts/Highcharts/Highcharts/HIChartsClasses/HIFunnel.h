...
*/
@property(nonatomic, readwrite) HIFunnelPoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIFunnelStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIFunnelLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIFunnelTooltip *tooltip;
/**
...
function.
*/
@property(nonatomic, readwrite) HIFunnelEvents *events;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIFunnelMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIFunnelZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIFunnelAnimation *animation;
/**
