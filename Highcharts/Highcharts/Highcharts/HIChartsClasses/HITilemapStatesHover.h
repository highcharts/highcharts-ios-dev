...
*/
@interface HITilemapStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HITilemapStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HITilemapStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HITilemapStatesHoverMarker *marker;
/**
