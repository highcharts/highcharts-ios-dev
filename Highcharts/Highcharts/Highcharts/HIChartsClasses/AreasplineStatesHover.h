...
*/
@interface AreasplineStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) AreasplineStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) AreasplineStatesHoverHalo *halo;
