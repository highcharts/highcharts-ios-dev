...
*/
@interface PlotOptionsAreasplinerangeDataLabels: HIChartsJSONSerializable
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/arearange-datalabels/" target="_blank">Data labels on range series</a>
*/
