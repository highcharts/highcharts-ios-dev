...
*/
@interface HISolidgaugeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HISolidgaugeStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HISolidgaugeStatesHoverHalo *halo;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HISolidgaugeStatesHoverAnimation *animation;
