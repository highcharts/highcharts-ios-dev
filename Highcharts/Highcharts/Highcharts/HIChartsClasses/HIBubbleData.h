...
/**
* description: An array of data points for the series. For the bubble series type, points can be given in the following ways:
 
An array of arrays with 3 or 2 values. In this case, the values correspond to x,y,z. If the first value is a string, it is
...
*/
@interface HIBubbleData: HIChartsJSONSerializable
...
/**
* description: The size value for each bubble. The bubbles' diameters are computed based on the z, and controlled by series options like minSize, maxSize, sizeBy, zMin and zMax.
*/
...
*/
@property(nonatomic, readwrite) HIBubbleDataEvents *events;
/**
