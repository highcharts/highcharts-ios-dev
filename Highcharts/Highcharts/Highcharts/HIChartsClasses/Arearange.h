...
/**
* description: <p>A <code>arearange</code> series. If the <a href="#series<arearange>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
@property(nonatomic, readwrite) ArearangeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) ArearangeTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) ArearangeHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) ArearangeDataLabels *dataLabels;
/**
