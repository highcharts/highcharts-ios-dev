...
*/
@interface PlotOptionsWaterfallStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsWaterfallStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsWaterfallStatesHoverMarker *marker;
