...
*/
@interface PlotOptionsPyramid: HIChartsJSONSerializable
...
@property(nonatomic, readwrite) PlotOptionsPyramidDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPyramidTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPyramidHIPoint *point;
/**
...
@property(nonatomic, readwrite) PlotOptionsPyramidEvents *events;
/**
