...
/**
* description: <p>A <code>column</code> series. If the <a href="#series<column>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) ColumnTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) ColumnHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) ColumnDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) ColumnEvents *events;
/**
