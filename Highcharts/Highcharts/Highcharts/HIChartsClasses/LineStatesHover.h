...
*/
@interface LineStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) LineStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) LineStatesHoverMarker *marker;
/**
