...
/**
* description: <p>A <code>heatmap</code> series. If the <a href="#series<heatmap>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) HeatmapDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*HeatmapZones*/ *zones;
/**
* description: Properties for each single point
*/
@property(nonatomic, readwrite) HeatmapHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) HeatmapTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*HeatmapStates*/ *states;
/**
...
@property(nonatomic, readwrite) HeatmapEvents *events;
/**
