...
*/
@interface HIPlotOptionsBubbleTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBubbleTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
