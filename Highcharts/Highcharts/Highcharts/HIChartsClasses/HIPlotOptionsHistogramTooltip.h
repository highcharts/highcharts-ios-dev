...
*/
@interface HIPlotOptionsHistogramTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHistogramTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
