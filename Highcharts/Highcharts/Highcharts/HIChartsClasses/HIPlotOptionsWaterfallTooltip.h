...
*/
@interface HIPlotOptionsWaterfallTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsWaterfallTooltipDateTimeLabelFormats *dateTimeLabelFormats;
