...
*/
@property(nonatomic, readwrite) NSArray <HIColumnrangeStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIColumnrangeZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIColumnrangeLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIColumnrangeAnimation *animation;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIColumnrangeMarker *marker;
/**
