...
*/
@interface PlotOptionsAreasplinerangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsAreasplinerangeStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsAreasplinerangeStatesHoverHalo *halo;
/**
