...
*/
@interface HIVariwideData: HIChartsJSONSerializable
...
/**
* description: The relative width for each column. The widths are distributed so they sum 
...
*/
@property(nonatomic, readwrite) HIVariwideDataEvents *events;
/**
