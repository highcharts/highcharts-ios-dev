...
*/
@interface PlotOptionsBoxplotStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsBoxplotStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsBoxplotStatesHoverMarker *marker;
/**
