...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsAreasplineStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsAreasplineZones *> *zones;
/**
