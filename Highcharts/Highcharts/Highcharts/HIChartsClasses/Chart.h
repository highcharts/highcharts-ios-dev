...
*/
@interface Chart: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) ChartOptions3d *options3d;
/**
...
*/
@property(nonatomic, readwrite) ChartEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HexColor *plotBackgroundColor;
/**
...
*/
@property(nonatomic, readwrite) HexColor *plotBorderColor;
/**
...
*/
@property(nonatomic, readwrite) ChartResetZoomButton *resetZoomButton;
/**
* description: The background color of the marker square when selecting (zooming in on) an area of the chart.
*/
@property(nonatomic, readwrite) HexColor *selectionMarkerFill;
/**
