...
*/
@interface PlotOptionsLineStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsLineStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsLineStatesHoverHalo *halo;
/**
