...
*/
@interface ArearangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) ArearangeStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) ArearangeStatesHoverMarker *marker;
