...
*/
@interface HIAreasplineData: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIAreasplineDataEvents *events;
/**
...
@property(nonatomic, readwrite) HIAreasplineDataMarker *marker;
/**
