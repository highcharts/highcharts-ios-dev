...
*/
@interface HIPlotOptionsAreasplineMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplineMarkerStatesHoverAnimation *animation;
/**
