...
@interface HIPlotOptionsLine: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsLineMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsLineStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsLineDataLabels *dataLabels;
/**
* description: Properties for each single point
*/
@property(nonatomic, readwrite) HIPlotOptionsLinePoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsLineZones *> *zones;
/**
...
@property(nonatomic, readwrite) HIPlotOptionsLineEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsLineTooltip *tooltip;
/**
...
* demo: http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/line-step/ : Different step line options
