...
*/
@interface HIScatterData: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIScatterDataEvents *events;
@property(nonatomic, readwrite) HIScatterDataMarker *marker;
/**
