...
*/
@interface PyramidStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PyramidStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PyramidStatesHoverHalo *halo;
