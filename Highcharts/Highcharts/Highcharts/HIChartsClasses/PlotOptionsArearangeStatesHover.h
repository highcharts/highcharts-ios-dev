...
*/
@interface PlotOptionsArearangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsArearangeStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsArearangeStatesHoverMarker *marker;
/**
