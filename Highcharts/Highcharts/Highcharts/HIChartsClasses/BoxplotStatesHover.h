...
*/
@interface BoxplotStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) BoxplotStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) BoxplotStatesHoverHalo *halo;
/**
