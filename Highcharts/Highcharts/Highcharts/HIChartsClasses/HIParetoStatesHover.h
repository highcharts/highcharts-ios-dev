...
*/
@interface HIParetoStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIParetoStatesHoverMarker *marker;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIParetoStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIParetoStatesHoverHalo *halo;
/**
