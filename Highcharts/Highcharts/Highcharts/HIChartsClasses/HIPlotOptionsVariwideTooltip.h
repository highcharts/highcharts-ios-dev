...
*/
@interface HIPlotOptionsVariwideTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariwideTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
