...
*/
@interface PlotOptionsHeatmap: HIChartsJSONSerializable

@property(nonatomic, readwrite) PlotOptionsHeatmapEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsHeatmapHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsHeatmapTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsHeatmapDataLabels *dataLabels;
