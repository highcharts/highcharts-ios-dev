...
*/
@property(nonatomic, readwrite) ColumnrangeTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) ColumnrangeHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*ColumnrangeZones*/ *zones;
/**
...
*/
@property(nonatomic, readwrite) ColumnrangeDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) ColumnrangeEvents *events;
/**
