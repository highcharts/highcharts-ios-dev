...
*/
@interface HIPlotOptionsSunburstTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSunburstTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
