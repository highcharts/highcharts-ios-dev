...
/**
* description: <p>A <code>polygon</code> series. If the <a href="#series<polygon>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) PolygonHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) PolygonTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PolygonMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PolygonDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) PolygonEvents *events;
/**
