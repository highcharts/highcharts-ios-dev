...
*/
@interface PlotOptionsColumnStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnStatesHoverHalo *halo;
