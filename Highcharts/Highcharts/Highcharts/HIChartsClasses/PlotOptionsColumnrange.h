...
*/
@interface PlotOptionsColumnrange: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) NSMutableArray /*PlotOptionsColumnrangeStates*/ *states;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnrangeHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnrangeDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) PlotOptionsColumnrangeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnrangeTooltip *tooltip;
/**
