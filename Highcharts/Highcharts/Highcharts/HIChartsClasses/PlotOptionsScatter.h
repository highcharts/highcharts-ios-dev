...
@interface PlotOptionsScatter: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsScatterMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsScatterTooltip *tooltip;
/**
...
@property(nonatomic, readwrite) PlotOptionsScatterEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsScatterHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsScatterDataLabels *dataLabels;
/**
