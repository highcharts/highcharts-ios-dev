...
/**
* description: <p>A <code>line</code> series. If the <a href="#series<line>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) LineTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) LineHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) LineMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*LineStates*/ *states;
/**
...
@property(nonatomic, readwrite) LineEvents *events;
/**
...
*/
@property(nonatomic, readwrite) LineDataLabels *dataLabels;
/**
