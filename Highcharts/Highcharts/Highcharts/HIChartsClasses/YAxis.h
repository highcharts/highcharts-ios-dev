...
*/
@interface YAxis: HIChartsJSONSerializable
...
/**
* description: Whether to force the axis to start on a tick. Use this option with the <code>maxPadding</code> option to control the axis start.
...
@property(nonatomic, readwrite) YAxisLabels *labels;
/**
...
/**
* description: If <code>true</code>, the first series in a stack will be drawn on top in a positive, non-reversed Y axis. If <code>false</code>, the first series is in the base of the stack.
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/yaxis/reversedstacks-false/" target="_blank">Non-reversed stacks</a>.
*/
...
*/
@property(nonatomic, readwrite) YAxisStackLabels *stackLabels;
/**
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/yaxis/angle/" target="_blank">Dual axis polar chart</a>
*/
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/yaxis/maxpadding-02/" target="_blank">Max padding of 0.2</a>
*/
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/demo/gauge-solid/" target="_blank">True by default</a>
*/
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/yaxis/mincolor-maxcolor/" target="_blank">Min and max color</a>
*/
@property(nonatomic, readwrite) HexColor *minColor;
/**
...
*/
@property(nonatomic, readwrite) YAxisCrosshair *crosshair;
/**
* description: The axis title, showing next to the axis line.
*/
@property(nonatomic, readwrite) YAxisTitle *title;
/**
...
@property(nonatomic, readwrite) YAxisEvents *events;
/**
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/yaxis/mincolor-maxcolor/" target="_blank">Min and max colors</a>
*/
@property(nonatomic, readwrite) HexColor *maxColor;
/**
...
/**
* description: Polar charts only. Whether the grid lines should draw as a polygon with straight lines between categories, or as circles. Can be either <code>circle</code> or <code>polygon</code>.
