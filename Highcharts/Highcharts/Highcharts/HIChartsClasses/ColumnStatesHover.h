...
*/
@interface ColumnStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) ColumnStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) ColumnStatesHoverHalo *halo;
/**
