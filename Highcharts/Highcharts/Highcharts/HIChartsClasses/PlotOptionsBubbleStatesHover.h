...
*/
@interface PlotOptionsBubbleStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsBubbleStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsBubbleStatesHoverMarker *marker;
