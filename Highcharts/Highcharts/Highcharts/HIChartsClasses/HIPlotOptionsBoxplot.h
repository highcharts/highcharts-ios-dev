...
*/
@property(nonatomic, readwrite) HIPlotOptionsBoxplotAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBoxplotDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBoxplotLabel *label;
/**
