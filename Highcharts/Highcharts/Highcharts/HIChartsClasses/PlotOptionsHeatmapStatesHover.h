...
*/
@interface PlotOptionsHeatmapStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsHeatmapStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsHeatmapStatesHoverMarker *marker;
/**
