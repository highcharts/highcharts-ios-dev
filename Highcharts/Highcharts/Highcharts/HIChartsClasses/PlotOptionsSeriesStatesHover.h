...
*/
@interface PlotOptionsSeriesStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsSeriesStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsSeriesStatesHoverMarker *marker;
/**
