...
*/
@interface HISankeyStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HISankeyStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HISankeyStatesHoverHalo *halo;
/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HISankeyStatesHoverAnimation *animation;
/**
