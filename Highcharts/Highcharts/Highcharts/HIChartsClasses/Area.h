...
/**
* description: <p>A <code>area</code> series. If the <a href="#series<area>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) NSMutableArray /*AreaStates*/ *states;
/**
...
*/
@property(nonatomic, readwrite) AreaTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) AreaMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) AreaHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) AreaDataLabels *dataLabels;
@property(nonatomic, readwrite) AreaEvents *events;
/**
