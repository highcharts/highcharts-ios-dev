...
- (void)setCategories:(NSArray<NSString *> *)categories redraw:(NSNumber *)redraw {
...
- (void)setTitle:(HITitle *)title redraw:(NSNumber *)redraw {
...
- (void)update:(HIXAxis *)options {
    ...
    self.jsClassMethod = @{ @"class" : @"Axis", @"method" : @"update", @"id" : self.uuid, @"params" : @[params], @"axis" : @"x" };
}
