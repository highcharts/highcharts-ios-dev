...
*/
@interface HIPlotOptionsSunburst: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSunburstDataLabels *dataLabels;
/**
...
* demo: https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/sunburst : Sunburst chart
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsSunburstLevels *> *levels;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsSunburstEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSunburstLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSunburstTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSunburstPoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsSunburstStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSunburstAnimation *animation;
