...
*/
@interface PlotOptionsFunnelStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsFunnelStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsFunnelStatesHoverMarker *marker;
