...
*/
@interface HeatmapStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HeatmapStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HeatmapStatesHoverMarker *marker;
