...
*/
@interface PieStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PieStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PieStatesHoverHalo *halo;
