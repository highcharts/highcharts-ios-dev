...
*/
@interface PolygonStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PolygonStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PolygonStatesHoverHalo *halo;
/**
