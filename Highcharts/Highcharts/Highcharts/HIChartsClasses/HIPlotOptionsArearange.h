...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsArearangeZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsArearangeStates *> *states;
/**
