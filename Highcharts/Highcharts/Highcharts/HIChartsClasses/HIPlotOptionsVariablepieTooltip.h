...
*/
@interface HIPlotOptionsVariablepieTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
