...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsAreasplinerangeZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsAreasplinerangeStates *> *states;
/**
