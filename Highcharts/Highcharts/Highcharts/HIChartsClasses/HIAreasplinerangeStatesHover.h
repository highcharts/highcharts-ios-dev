...
*/
@interface HIAreasplinerangeStatesHover: HIChartsJSONSerializable

/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIAreasplinerangeStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIAreasplinerangeStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIAreasplinerangeStatesHoverMarker *marker;
