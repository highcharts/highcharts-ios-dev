...
*/
@interface PlotOptionsSeries: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsSeriesTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsSeriesDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) PlotOptionsSeriesEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsSeriesMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsSeriesHIPoint *point;
/**
