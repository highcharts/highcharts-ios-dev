...
/**
* description: An array of data points for the series. For the <code>area</code> series type, points can be given in the following ways:
 <ol>
...
*/
@interface AreaData: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) AreaDataEvents *events;
/**
...
@property(nonatomic, readwrite) AreaDataMarker *marker;
/**
