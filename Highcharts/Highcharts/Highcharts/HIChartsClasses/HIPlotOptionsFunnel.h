...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsFunnelStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsFunnelZones *> *zones;
/**
