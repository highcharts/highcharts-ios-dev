...
*/
@interface HIPlotOptionsAreaStatesHoverMarkerStatesHover: HIChartsJSONSerializable

/**
* description: Animation when hovering over the marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsAreaStatesHoverMarkerStatesHoverAnimation *animation;
/**
