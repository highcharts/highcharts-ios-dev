...
*/
@interface HIPlotOptionsBoxplotTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBoxplotTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
