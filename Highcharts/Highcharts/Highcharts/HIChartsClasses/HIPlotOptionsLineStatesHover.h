...
*/
@interface HIPlotOptionsLineStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsLineStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsLineStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsLineStatesHoverHalo *halo;
