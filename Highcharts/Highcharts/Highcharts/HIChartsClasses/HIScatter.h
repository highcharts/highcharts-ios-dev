...
/**
* description: A scatter series. If the type option is not specified, it is inherited from chart.type.
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIScatterZones *> *zones;
/**
