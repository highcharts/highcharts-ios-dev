...
/**
* description: <p>A <code>scatter</code> series. If the <a href="#series<scatter>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) HIScatterMarker *marker;
/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSMutableArray /*HIScatterStates*/ *states;
/**
...
*/
@property(nonatomic, readwrite) HIScatterDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIScatterTooltip *tooltip;
/**
...
@property(nonatomic, readwrite) HIScatterEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIScatterPoint *point;
/**
