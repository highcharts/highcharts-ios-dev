...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsErrorbarZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsErrorbarStates *> *states;
/**
