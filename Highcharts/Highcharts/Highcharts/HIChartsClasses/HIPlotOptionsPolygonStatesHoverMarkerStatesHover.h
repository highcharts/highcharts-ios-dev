...
*/
@interface HIPlotOptionsPolygonStatesHoverMarkerStatesHover: HIChartsJSONSerializable

/**
* description: Animation when hovering over the marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonStatesHoverMarkerStatesHoverAnimation *animation;
/**
