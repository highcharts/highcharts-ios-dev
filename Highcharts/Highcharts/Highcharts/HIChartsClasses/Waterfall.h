...
/**
* description: <p>A <code>waterfall</code> series. If the <a href="#series<waterfall>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) NSMutableArray /*WaterfallStates*/ *states;
/**
...
@property(nonatomic, readwrite) WaterfallEvents *events;
/**
...
*/
@property(nonatomic, readwrite) WaterfallDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) WaterfallHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) WaterfallTooltip *tooltip;
/**
