...
*/
@interface PlotOptionsPyramidStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsPyramidStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPyramidStatesHoverMarker *marker;
/**
