...
*/
@interface BarStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) BarStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) BarStatesHoverHalo *halo;
