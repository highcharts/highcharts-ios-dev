...
/**
* description: <p>A <code>errorbar</code> series. If the <a href="#series<errorbar>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
@property(nonatomic, readwrite) ErrorbarEvents *events;
/**
...
*/
@property(nonatomic, readwrite) ErrorbarHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*ErrorbarStates*/ *states;
/**
...
*/
@property(nonatomic, readwrite) ErrorbarTooltip *tooltip;
/**
