...
/**
* description: An array of data points for the series. For the column series type, points can be given in the following ways:
...
*/
@interface HIColumnData: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIColumnDataEvents *events;
/**
