...
*/
@interface PlotOptionsAreaStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsAreaStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsAreaStatesHoverHalo *halo;
