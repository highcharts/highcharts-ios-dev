...
*/
@interface PlotOptionsErrorbarStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsErrorbarStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsErrorbarStatesHoverHalo *halo;
