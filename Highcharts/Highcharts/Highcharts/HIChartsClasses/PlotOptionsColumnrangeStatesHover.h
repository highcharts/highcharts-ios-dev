...
*/
@interface PlotOptionsColumnrangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnrangeStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsColumnrangeStatesHoverMarker *marker;
