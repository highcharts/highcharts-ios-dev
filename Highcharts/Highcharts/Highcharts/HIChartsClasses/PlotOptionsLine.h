...
@interface PlotOptionsLine: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsLineMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*PlotOptionsLineStates*/ *states;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsLineDataLabels *dataLabels;
/**
* description: Properties for each single point
*/
@property(nonatomic, readwrite) PlotOptionsLineHIPoint *point;
/**
...
@property(nonatomic, readwrite) PlotOptionsLineEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsLineTooltip *tooltip;
/**
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/line-step/" target="_blank">Different step line options</a>
