...
@interface PlotOptionsAreaspline: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsAreasplineMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsAreasplineHIPoint *point;
/**
...
@property(nonatomic, readwrite) PlotOptionsAreasplineEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsAreasplineTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*PlotOptionsAreasplineStates*/ *states;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsAreasplineDataLabels *dataLabels;
/**
