...
*/
@interface HIPyramidStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPyramidStatesHoverMarkerStatesHoverAnimation *animation;
/**
