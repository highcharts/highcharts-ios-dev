...
*/
@interface XAxis: HIChartsJSONSerializable

/**
* description: Event handlers for the axis.
*/
@property(nonatomic, readwrite) XAxisEvents *events;
/**
...
*/
@property(nonatomic, readwrite) XAxisTitle *title;
/**
...
*/
@property(nonatomic, readwrite) XAxisCrosshair *crosshair;
/**
...
*/
@property(nonatomic, readwrite) XAxisLabels *labels;
/**
