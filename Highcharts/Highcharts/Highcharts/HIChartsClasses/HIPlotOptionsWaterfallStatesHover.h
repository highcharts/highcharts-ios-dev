...
*/
@interface HIPlotOptionsWaterfallStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsWaterfallStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsWaterfallStatesHoverMarker *marker;
