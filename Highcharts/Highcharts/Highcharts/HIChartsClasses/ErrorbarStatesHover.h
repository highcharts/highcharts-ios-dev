...
*/
@interface ErrorbarStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) ErrorbarStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) ErrorbarStatesHoverHalo *halo;
/**
