...
*/
@interface AreasplinerangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) AreasplinerangeStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) AreasplinerangeStatesHoverHalo *halo;
/**
