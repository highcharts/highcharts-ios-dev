...
*/
@property(nonatomic, readwrite) HIColumnLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIColumnStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIColumnAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIColumnDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIColumnPoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIColumnZones *> *zones;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIColumnMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIColumnTooltip *tooltip;
/**
