...
*/
@interface AreaStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) AreaStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) AreaStatesHoverHalo *halo;
/**
