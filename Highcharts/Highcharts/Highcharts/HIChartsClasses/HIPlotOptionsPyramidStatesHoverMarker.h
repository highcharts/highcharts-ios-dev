...
*/
@interface HIPlotOptionsPyramidStatesHoverMarker: HIChartsJSONSerializable

/**
* description: States for a single point marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsPyramidStatesHoverMarkerStates *states;
/**
