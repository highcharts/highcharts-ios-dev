...
-(id)copyWithZone:(NSZone *)zone {
	...
	copyPie.negativeColor = [self.negativeColor copyWithZone: zone];
	copyPie.pointInterval = [self.pointInterval copyWithZone: zone];
	copyPie.cropThreshold = [self.cropThreshold copyWithZone: zone];
	copyPie.colorKey = [self.colorKey copyWithZone: zone];
	copyPie.softThreshold = [self.softThreshold copyWithZone: zone];
	copyPie.dragDrop = [self.dragDrop copyWithZone: zone];
	copyPie.dataSorting = [self.dataSorting copyWithZone: zone];
	copyPie.marker = [self.marker copyWithZone: zone];
	...
	copyPie.dashStyle = [self.dashStyle copyWithZone: zone];
	copyPie.pointPlacement = [self.pointPlacement copyWithZone: zone];
	copyPie.connectNulls = [self.connectNulls copyWithZone: zone];
	...
	copyPie.stacking = [self.stacking copyWithZone: zone];
	copyPie.animation = [self.animation copyWithZone: zone];
	copyPie.findNearestPointBy = [self.findNearestPointBy copyWithZone: zone];
	copyPie.relativeXValue = [self.relativeXValue copyWithZone: zone];
	copyPie.threshold = [self.threshold copyWithZone: zone];
	...
	copyPie.animationLimit = [self.animationLimit copyWithZone: zone];
	copyPie.turboThreshold = [self.turboThreshold copyWithZone: zone];
	...
	copyPie.step = [self.step copyWithZone: zone];
	copyPie.getExtremesFromAll = [self.getExtremesFromAll copyWithZone: zone];
	...
	copyPie.zones = [self.zones copyWithZone: zone];
	copyPie.pointIntervalUnit = [self.pointIntervalUnit copyWithZone: zone];
	copyPie.lineWidth = [self.lineWidth copyWithZone: zone];
	...
	copyPie.zoneAxis = [self.zoneAxis copyWithZone: zone];
	copyPie.className = [self.className copyWithZone: zone];
	copyPie.pointStart = [self.pointStart copyWithZone: zone];
	copyPie.connectEnds = [self.connectEnds copyWithZone: zone];
	copyPie.boostThreshold = [self.boostThreshold copyWithZone: zone];
	...
	copyPie.stack = [self.stack copyWithZone: zone];
	copyPie.type = [self.type copyWithZone: zone];
	copyPie.xAxis = [self.xAxis copyWithZone: zone];
	copyPie.yAxis = [self.yAxis copyWithZone: zone];
