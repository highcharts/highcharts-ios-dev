...
-(id)copyWithZone:(NSZone *)zone {
	...
	HIFrequency *copyFrequency = [[HIFrequency allocWithZone: zone] init];
	copyFrequency.mapFunction = [self.mapFunction copyWithZone: zone];
	copyFrequency.min = [self.min copyWithZone: zone];
	copyFrequency.max = [self.max copyWithZone: zone];
	copyFrequency.within = [self.within copyWithZone: zone];
	copyFrequency.value = [self.value copyWithZone: zone];
	copyFrequency.mapTo = [self.mapTo copyWithZone: zone];
