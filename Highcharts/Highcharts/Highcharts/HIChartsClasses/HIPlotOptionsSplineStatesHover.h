...
*/
@interface HIPlotOptionsSplineStatesHover: HIChartsJSONSerializable

/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineStatesHoverHalo *halo;
