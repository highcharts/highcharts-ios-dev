...
/**
* description: <p>A <code>pyramid</code> series. If the <a href="#series<pyramid>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) PyramidTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*PyramidStates*/ *states;
/**
...
@property(nonatomic, readwrite) PyramidDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) PyramidEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PyramidHIPoint *point;
/**
