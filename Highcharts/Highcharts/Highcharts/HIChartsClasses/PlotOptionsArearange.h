...
*/
@interface PlotOptionsArearange: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsArearangeDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsArearangeTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsArearangeHIPoint *point;
/**
...
@property(nonatomic, readwrite) PlotOptionsArearangeEvents *events;
/**
