...
*/
@interface ColumnrangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) ColumnrangeStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) ColumnrangeStatesHoverMarker *marker;
/**
