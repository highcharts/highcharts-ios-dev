...
*/
@interface HIPlotOptionsAreaTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreaTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
