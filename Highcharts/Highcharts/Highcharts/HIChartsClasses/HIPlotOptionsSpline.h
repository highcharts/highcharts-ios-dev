...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsSplineStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray <HIPlotOptionsSplineZones *> *zones;
/**
