...
-(id)copyWithZone:(NSZone *)zone {
	...
	copyGeoJSON.hcTransform = [self.hcTransform copyWithZone: zone];
...
-(NSDictionary *)getParams
{
	...
	if (self.hcTransform) {
		params[@"hc-transform"] = self.hcTransform;
	}
	if (self.title) {
...
-(void)sethcTransform:(id)hcTransform {
	id oldValue = _hcTransform;
	_hcTransform = hcTransform;
	[self updateNSObject:oldValue newValue:hcTransform propertyName:@"hcTransform"];
}
