...
*/
@interface PlotOptionsFunnel: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) NSMutableArray /*PlotOptionsFunnelStates*/ *states;
/**
...
@property(nonatomic, readwrite) PlotOptionsFunnelEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsFunnelTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsFunnelHIPoint *point;
/**
...
@property(nonatomic, readwrite) PlotOptionsFunnelDataLabels *dataLabels;
/**
