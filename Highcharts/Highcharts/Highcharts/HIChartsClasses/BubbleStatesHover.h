...
*/
@interface BubbleStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) BubbleStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) BubbleStatesHoverMarker *marker;
/**
