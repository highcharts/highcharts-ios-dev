...
*/
@interface HIPlotOptionsSplineTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineTooltipDateTimeLabelFormats *dateTimeLabelFormats;
