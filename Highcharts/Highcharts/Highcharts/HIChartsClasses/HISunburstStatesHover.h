...
*/
@interface HISunburstStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HISunburstStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HISunburstStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HISunburstStatesHoverMarker *marker;
/**
