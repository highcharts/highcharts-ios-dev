...
*/
@interface HIPlotOptionsErrorbarStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsErrorbarStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsErrorbarStatesHoverHalo *halo;
