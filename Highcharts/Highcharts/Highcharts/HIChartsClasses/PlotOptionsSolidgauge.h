...
*/
@interface PlotOptionsSolidgauge: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) PlotOptionsSolidgaugeDataLabels *dataLabels;
@property(nonatomic, readwrite) PlotOptionsSolidgaugeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsSolidgaugeTooltip *tooltip;
/**
* description: Properties for each single point
*/
@property(nonatomic, readwrite) PlotOptionsSolidgaugeHIPoint *point;
