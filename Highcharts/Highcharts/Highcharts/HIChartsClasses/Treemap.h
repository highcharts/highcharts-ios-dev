...
/**
* description: <p>A <code>treemap</code> series. If the <a href="#series<treemap>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) TreemapHIPoint *point;
/**
...
@property(nonatomic, readwrite) TreemapTooltip *tooltip;
/**
...
@property(nonatomic, readwrite) TreemapEvents *events;
/**
...
*/
@property(nonatomic, readwrite) TreemapStates *states;
/**
...
@property(nonatomic, readwrite) TreemapDataLabels *dataLabels;
/**
