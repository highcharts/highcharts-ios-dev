...
/**
* description: <p>A <code>solidgauge</code> series. If the <a href="#series<solidgauge>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@interface Solidgauge: Series

/**
* description: Properties for each single point
*/
@property(nonatomic, readwrite) SolidgaugeHIPoint *point;
/**
...
*/
@property(nonatomic, readwrite) SolidgaugeDataLabels *dataLabels;
/**
...
@property(nonatomic, readwrite) SolidgaugeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) SolidgaugeTooltip *tooltip;
/**
...
/**
* description: Whether the strokes of the solid gauge should be <code>round</code> or <code>square</code>.
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/demo/gauge-activity/" target="_blank">Rounded gauge</a>
...
* demo: <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/solidgauge-threshold/" target="_blank">Zero threshold with negative and positive values</a>
*/
