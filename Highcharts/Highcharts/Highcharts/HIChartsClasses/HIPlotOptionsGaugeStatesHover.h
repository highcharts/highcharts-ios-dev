...
*/
@interface HIPlotOptionsGaugeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeStatesHoverHalo *halo;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeStatesHoverAnimation *animation;
/**
