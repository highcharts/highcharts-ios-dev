...
*/
@interface HIPlotOptionsArearangeMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeMarkerStatesHoverAnimation *animation;
/**
