...
/**
* description: <p>A <code>pie</code> series. If the <a href="#series<pie>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
@property(nonatomic, readwrite) PieEvents *events;
/**
...
*/
@property(nonatomic, readwrite) PieTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PieHIPoint *point;
/**
...
@property(nonatomic, readwrite) PieDataLabels *dataLabels;
/**
