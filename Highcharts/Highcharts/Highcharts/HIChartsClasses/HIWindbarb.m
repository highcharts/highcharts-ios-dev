...
-(id)copyWithZone:(NSZone *)zone {
	...
	copyWindbarb.cropThreshold = [self.cropThreshold copyWithZone: zone];
	...
	copyWindbarb.linecap = [self.linecap copyWithZone: zone];
	...
	copyWindbarb.marker = [self.marker copyWithZone: zone];
	...
	copyWindbarb.dashStyle = [self.dashStyle copyWithZone: zone];
	copyWindbarb.pointPlacement = [self.pointPlacement copyWithZone: zone];
	copyWindbarb.connectNulls = [self.connectNulls copyWithZone: zone];
	...
	copyWindbarb.stacking = [self.stacking copyWithZone: zone];
	...
	copyWindbarb.step = [self.step copyWithZone: zone];
	copyWindbarb.getExtremesFromAll = [self.getExtremesFromAll copyWithZone: zone];
	copyWindbarb.shadow = [self.shadow copyWithZone: zone];
	...
	copyWindbarb.connectEnds = [self.connectEnds copyWithZone: zone];
	copyWindbarb.boostThreshold = [self.boostThreshold copyWithZone: zone];
