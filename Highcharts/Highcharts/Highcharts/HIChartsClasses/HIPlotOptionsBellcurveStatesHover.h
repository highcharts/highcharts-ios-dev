...
*/
@interface HIPlotOptionsBellcurveStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBellcurveStatesHoverMarker *marker;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsBellcurveStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBellcurveStatesHoverHalo *halo;
/**
