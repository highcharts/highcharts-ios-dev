...
/**
* description: A arearange series. If the type option is not specified, it is inherited from chart.type.
...
@property(nonatomic, readwrite) HIArearangeEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIArearangeTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIArearangePoint *point;
/**
...
*/
@property(nonatomic, readwrite) HIArearangeDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIArearangeStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIArearangeZones *> *zones;
