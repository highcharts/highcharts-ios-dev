...
*/
@interface PlotOptionsPie: HIChartsJSONSerializable

@property(nonatomic, readwrite) PlotOptionsPieEvents *events;
/**
...
*/
@property(nonatomic, readwrite) NSMutableArray /*PlotOptionsPieStates*/ *states;
/**
...
@property(nonatomic, readwrite) PlotOptionsPieDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPieTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) PlotOptionsPieHIPoint *point;
/**
