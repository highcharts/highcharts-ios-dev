...
/**
* description: <p>A <code>bar</code> series. If the <a href="#series<bar>.type">type</a> option is not specified, it is inherited from <a href="#chart.type">chart.type</a>.</p>
...
*/
@property(nonatomic, readwrite) BarTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) BarHIPoint *point;
@property(nonatomic, readwrite) BarEvents *events;
/**
...
@property(nonatomic, readwrite) BarDataLabels *dataLabels;
/**
