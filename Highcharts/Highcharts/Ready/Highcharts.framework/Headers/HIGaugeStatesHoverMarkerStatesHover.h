...
*/
@interface HIGaugeStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIGaugeStatesHoverMarkerStatesHoverAnimation *animation;
/**
