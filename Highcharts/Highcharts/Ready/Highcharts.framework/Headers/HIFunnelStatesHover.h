...
*/
@interface HIFunnelStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIFunnelStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIFunnelStatesHoverMarker *marker;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIFunnelStatesHoverAnimation *animation;
