...
*/
@interface HIStreamgraphDataMarkerStates: HIChartsJSONSerializable
...
option to true.
*/
@property(nonatomic, readwrite) HIStreamgraphDataMarkerStatesSelect *select;
/**
* description: The hover state for a single point marker.
*/
@property(nonatomic, readwrite) HIStreamgraphDataMarkerStatesHover *hover;
