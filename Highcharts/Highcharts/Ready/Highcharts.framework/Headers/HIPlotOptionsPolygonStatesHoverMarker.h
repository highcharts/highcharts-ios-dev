...
*/
@interface HIPlotOptionsPolygonStatesHoverMarker: HIChartsJSONSerializable

/**
* description: States for a single point marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsPolygonStatesHoverMarkerStates *states;
/**
