...
/**
* description: A bullet series. If the type option is not
...
class names.
*/
@property(nonatomic, readwrite) HIBulletMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIBulletLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIBulletPoint *point;
/**
...
function.
*/
@property(nonatomic, readwrite) HIBulletEvents *events;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIBulletZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIBulletTargetOptions *targetOptions;
/**
...
*/
@property(nonatomic, readwrite) HIBulletAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIBulletDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIBulletTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIBulletStates *> *states;
/**
