...
*/
@property(nonatomic, readwrite) HIPlotOptionsErrorbarDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsErrorbarAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsErrorbarLabel *label;
/**
