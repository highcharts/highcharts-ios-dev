...
*/
@interface HIXrangeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIXrangeStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIXrangeStatesHoverHalo *halo;
/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIXrangeStatesHoverAnimation *animation;
/**
