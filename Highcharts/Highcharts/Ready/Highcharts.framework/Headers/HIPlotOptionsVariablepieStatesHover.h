...
*/
@interface HIPlotOptionsVariablepieStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieStatesHoverAnimation *animation;
...
* demo: https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/pie-states-hover-brightness/ : Brightened by 0.5
* default: 0.1
*/
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieStatesHoverMarker *marker;
/**
