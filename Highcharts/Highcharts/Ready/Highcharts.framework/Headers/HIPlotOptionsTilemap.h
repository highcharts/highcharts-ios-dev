...
*/
@interface HIPlotOptionsTilemap: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsTilemapStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapDataLabels *dataLabels;
/**
* description: Properties for each single point.
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapPoint *point;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapEvents *events;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsTilemapZones *> *zones;
/**
...
@property(nonatomic, readwrite) HIPlotOptionsTilemapData *data;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapLabel *label;
/**
