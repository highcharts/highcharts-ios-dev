...
*/
@interface HIPlotOptionsParetoStatesHoverMarkerStates: HIChartsJSONSerializable
...
option to true.
*/
@property(nonatomic, readwrite) HIPlotOptionsParetoStatesHoverMarkerStatesSelect *select;
/**
* description: The hover state for a single point marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsParetoStatesHoverMarkerStatesHover *hover;
