...
*/
@interface HIScatter3dStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIScatter3dStatesHoverMarkerStatesHoverAnimation *animation;
