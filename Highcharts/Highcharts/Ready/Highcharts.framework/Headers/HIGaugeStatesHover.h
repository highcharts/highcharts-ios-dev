...
*/
@interface HIGaugeStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIGaugeStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIGaugeStatesHoverMarker *marker;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIGaugeStatesHoverAnimation *animation;
