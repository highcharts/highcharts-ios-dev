...
class names.
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsScatterZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsScatterStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterTooltip *tooltip;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterPoint *point;
/**
