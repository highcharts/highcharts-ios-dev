...
*/
@interface HIVectorStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIVectorStatesHoverMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIVectorStatesHoverHalo *halo;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIVectorStatesHoverAnimation *animation;
/**
