...
*/
@interface HIPlotOptionsParetoMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsParetoMarkerStatesHoverAnimation *animation;
