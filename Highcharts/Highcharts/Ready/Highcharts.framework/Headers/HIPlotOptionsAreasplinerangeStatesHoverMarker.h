...
*/
@interface HIPlotOptionsAreasplinerangeStatesHoverMarker: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsAreasplinerangeStatesHoverMarkerStates *states;
/**
