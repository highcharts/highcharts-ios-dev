...
*/
@interface HIPlotOptionsSeriesTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSeriesTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
