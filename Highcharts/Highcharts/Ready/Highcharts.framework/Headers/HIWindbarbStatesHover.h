...
*/
@interface HIWindbarbStatesHover: HIChartsJSONSerializable
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIWindbarbStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIWindbarbStatesHoverMarker *marker;
...
*/
@property(nonatomic, readwrite) HIWindbarbStatesHoverHalo *halo;
/**
