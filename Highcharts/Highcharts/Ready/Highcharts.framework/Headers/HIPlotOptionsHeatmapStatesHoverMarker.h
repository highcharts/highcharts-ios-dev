...
*/
@interface HIPlotOptionsHeatmapStatesHoverMarker: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsHeatmapStatesHoverMarkerStates *states;
/**
