...
*/
@interface HIPlotOptionsVectorTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVectorTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
