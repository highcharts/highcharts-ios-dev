...
*/
@interface HIPlotOptionsBarTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBarTooltipDateTimeLabelFormats *dateTimeLabelFormats;
