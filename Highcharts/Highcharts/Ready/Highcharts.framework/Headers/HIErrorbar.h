...
*/
@property(nonatomic, readwrite) NSArray <HIErrorbarStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIErrorbarAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIErrorbarZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HIErrorbarLabel *label;
/**
...
/**
* description: The main color of the bars. This can be overridden by stemColor and whiskerColor
individually.
...
*/
@property(nonatomic, readwrite) HIErrorbarDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIErrorbarPoint *point;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIErrorbarMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) HIErrorbarTooltip *tooltip;
/**
