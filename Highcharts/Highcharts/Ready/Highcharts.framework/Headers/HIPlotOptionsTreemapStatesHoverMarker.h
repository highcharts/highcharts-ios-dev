...
*/
@interface HIPlotOptionsTreemapStatesHoverMarker: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTreemapStatesHoverMarkerStates *states;
/**
