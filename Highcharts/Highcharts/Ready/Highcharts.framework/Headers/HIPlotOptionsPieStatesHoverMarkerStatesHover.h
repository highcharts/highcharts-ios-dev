...
*/
@interface HIPlotOptionsPieStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsPieStatesHoverMarkerStatesHoverAnimation *animation;
/**
