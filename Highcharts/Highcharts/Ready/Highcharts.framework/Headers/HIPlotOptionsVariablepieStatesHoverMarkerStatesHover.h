...
*/
@interface HIPlotOptionsVariablepieStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsVariablepieStatesHoverMarkerStatesHoverAnimation *animation;
/**
