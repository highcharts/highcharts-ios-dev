...
*/
@interface HIPlotOptionsScatter3dStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dStatesHoverMarkerStatesHoverAnimation *animation;
