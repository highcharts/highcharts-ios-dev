...
*/
@interface HIPlotOptionsSolidgaugeStatesHoverMarker: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeStatesHoverMarkerStates *states;
/**
* description: Image markers only. Set the image width explicitly. When using this
