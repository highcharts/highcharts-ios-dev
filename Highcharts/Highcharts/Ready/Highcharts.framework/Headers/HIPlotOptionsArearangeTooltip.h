...
*/
@interface HIPlotOptionsArearangeTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsArearangeTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
