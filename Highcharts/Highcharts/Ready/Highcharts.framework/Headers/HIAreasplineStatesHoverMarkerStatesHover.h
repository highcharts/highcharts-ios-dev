...
*/
@interface HIAreasplineStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIAreasplineStatesHoverMarkerStatesHoverAnimation *animation;
/**
