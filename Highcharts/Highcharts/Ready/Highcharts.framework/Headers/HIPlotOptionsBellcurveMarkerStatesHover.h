...
*/
@interface HIPlotOptionsBellcurveMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsBellcurveMarkerStatesHoverAnimation *animation;
/**
