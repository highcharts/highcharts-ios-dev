...
*/
@interface HIBoxplotStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIBoxplotStatesHoverMarker *marker;
/**
...
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIBoxplotStatesHoverAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIBoxplotStatesHoverHalo *halo;
/**
