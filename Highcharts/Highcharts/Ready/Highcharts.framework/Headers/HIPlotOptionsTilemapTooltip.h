...
*/
@interface HIPlotOptionsTilemapTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
