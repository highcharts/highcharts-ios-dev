...
*/
@property(nonatomic, readwrite) HITilemapDataLabels *dataLabels;
/**
...
class names.
*/
@property(nonatomic, readwrite) HITilemapMarker *marker;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HITilemapZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) HITilemapTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HITilemapLabel *label;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HITilemapStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HITilemapAnimation *animation;
/**
...
function.
*/
@property(nonatomic, readwrite) HITilemapEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HITilemapPoint *point;
/**
