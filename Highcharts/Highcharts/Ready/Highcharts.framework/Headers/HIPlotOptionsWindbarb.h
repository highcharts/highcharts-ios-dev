...
*/
@interface HIPlotOptionsWindbarb: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsWindbarbAnimation *animation;
/**
...
function.
*/
@property(nonatomic, readwrite) HIPlotOptionsWindbarbEvents *events;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsWindbarbZones *> *zones;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsWindbarbStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsWindbarbTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsWindbarbLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsWindbarbDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsWindbarbPoint *point;
/**
