...
*/
@interface HIAreasplinerangeMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIAreasplinerangeMarkerStatesHoverAnimation *animation;
/**
