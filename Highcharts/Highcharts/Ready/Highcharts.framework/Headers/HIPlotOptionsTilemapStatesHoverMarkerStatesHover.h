...
*/
@interface HIPlotOptionsTilemapStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsTilemapStatesHoverMarkerStatesHoverAnimation *animation;
