...
*/
@interface HIPlotOptionsSplineStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsSplineStatesHoverMarkerStatesHoverAnimation *animation;
/**
