...
/**
* description: A scatter3d series. If the type option is
...
*/
@property(nonatomic, readwrite) HIScatter3dLabel *label;
/**
...
function.
*/
@property(nonatomic, readwrite) HIScatter3dEvents *events;
/**
...
*/
@property(nonatomic, readwrite) HIScatter3dPoint *point;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIScatter3dZones *> *zones;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIScatter3dMarker *marker;
/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSArray <HIScatter3dStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIScatter3dDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIScatter3dAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIScatter3dTooltip *tooltip;
/**
