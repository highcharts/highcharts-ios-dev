...
*/
@interface HIPlotOptionsGaugeStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsGaugeStatesHoverMarkerStatesHoverAnimation *animation;
/**
