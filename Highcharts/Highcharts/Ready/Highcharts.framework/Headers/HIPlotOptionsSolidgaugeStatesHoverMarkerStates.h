...
*/
@interface HIPlotOptionsSolidgaugeStatesHoverMarkerStates: HIChartsJSONSerializable
...
option to true.
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeStatesHoverMarkerStatesSelect *select;
/**
* description: The hover state for a single point marker.
*/
@property(nonatomic, readwrite) HIPlotOptionsSolidgaugeStatesHoverMarkerStatesHover *hover;
