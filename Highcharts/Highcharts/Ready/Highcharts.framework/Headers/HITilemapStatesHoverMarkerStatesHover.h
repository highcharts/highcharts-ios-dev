...
*/
@interface HITilemapStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HITilemapStatesHoverMarkerStatesHoverAnimation *animation;
/**
