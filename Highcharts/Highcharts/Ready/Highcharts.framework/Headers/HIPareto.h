...
*/
@property(nonatomic, readwrite) HIParetoPoint *point;
/**
...
*/
@property(nonatomic, readwrite) HIParetoDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) HIParetoTooltip *tooltip;
/**
...
function.
*/
@property(nonatomic, readwrite) HIParetoEvents *events;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIParetoZones *> *zones;
/**
* description: A wrapper object for all the series options in specific states.
*/
@property(nonatomic, readwrite) NSArray <HIParetoStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIParetoAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIParetoLabel *label;
/**
...
class names.
*/
@property(nonatomic, readwrite) HIParetoMarker *marker;
/**
