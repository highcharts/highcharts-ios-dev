...
*/
@interface HIPolygonStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPolygonStatesHoverHalo *halo;
/**
...
*/
@property(nonatomic, readwrite) HIPolygonStatesHoverMarker *marker;
/**
* description: Animation setting for hovering the graph in line-type series.
* default: { "duration": 50 }
*/
@property(nonatomic, readwrite) HIPolygonStatesHoverAnimation *animation;
