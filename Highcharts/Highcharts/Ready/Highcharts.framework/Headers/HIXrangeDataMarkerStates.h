...
*/
@interface HIXrangeDataMarkerStates: HIChartsJSONSerializable
...
option to true.
*/
@property(nonatomic, readwrite) HIXrangeDataMarkerStatesSelect *select;
/**
* description: The hover state for a single point marker.
*/
@property(nonatomic, readwrite) HIXrangeDataMarkerStatesHover *hover;
