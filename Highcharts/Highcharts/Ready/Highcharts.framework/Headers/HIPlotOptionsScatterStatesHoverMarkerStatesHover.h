...
*/
@interface HIPlotOptionsScatterStatesHoverMarkerStatesHover: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatterStatesHoverMarkerStatesHoverAnimation *animation;
/**
