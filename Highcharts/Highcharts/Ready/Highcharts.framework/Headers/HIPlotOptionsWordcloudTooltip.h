...
*/
@interface HIPlotOptionsWordcloudTooltip: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsWordcloudTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
