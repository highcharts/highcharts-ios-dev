...
*/
@interface HIPlotOptionsScatter3dTooltip: HIChartsJSONSerializable
...
https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/tooltip/format/ : Format demo
* default: <span class="highcharts-color-{point.colorIndex}">●</span> <span class="highcharts-header"> {series.name}</span><br/>
*/
...
*/
@property(nonatomic, readwrite) HIPlotOptionsScatter3dTooltipDateTimeLabelFormats *dateTimeLabelFormats;
/**
