...
*/
@interface HIPlotOptionsFunnel: HIChartsJSONSerializable
...
*/
@property(nonatomic, readwrite) HIPlotOptionsFunnelAnimation *animation;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsFunnelTooltip *tooltip;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsFunnelLabel *label;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsFunnelDataLabels *dataLabels;
/**
...
*/
@property(nonatomic, readwrite) NSArray <HIPlotOptionsFunnelStates *> *states;
/**
...
*/
@property(nonatomic, readwrite) HIPlotOptionsFunnelPoint *point;
