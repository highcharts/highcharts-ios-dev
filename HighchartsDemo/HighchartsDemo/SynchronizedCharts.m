...
#import "SynchronizedCharts.h"
#import <Highcharts/HIGChartViewJS.h>

@interface SynchronizedCharts ()
@property (strong, nonatomic) HIGChartViewJS *chartView;
@end

@implementation SynchronizedCharts

+ (UIViewController*)controller
{
    SynchronizedCharts *demoViewController = [SynchronizedCharts new];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *jsPath = [[NSBundle mainBundle] pathForResource:@"SynchronizedCharts.js" ofType:nil];
