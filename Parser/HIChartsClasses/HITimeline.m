...
-(id)copyWithZone:(NSZone *)zone {
	...
	copyTimeline.stack = [self.stack copyWithZone: zone];
	...
	copyTimeline.negativeColor = [self.negativeColor copyWithZone: zone];
	copyTimeline.color = [self.color copyWithZone: zone];
	copyTimeline.pointInterval = [self.pointInterval copyWithZone: zone];
	copyTimeline.cropThreshold = [self.cropThreshold copyWithZone: zone];
	copyTimeline.softThreshold = [self.softThreshold copyWithZone: zone];
	...
	copyTimeline.dashStyle = [self.dashStyle copyWithZone: zone];
	copyTimeline.pointPlacement = [self.pointPlacement copyWithZone: zone];
	copyTimeline.connectNulls = [self.connectNulls copyWithZone: zone];
	...
	copyTimeline.stacking = [self.stacking copyWithZone: zone];
	copyTimeline.animation = [self.animation copyWithZone: zone];
	copyTimeline.findNearestPointBy = [self.findNearestPointBy copyWithZone: zone];
	copyTimeline.relativeXValue = [self.relativeXValue copyWithZone: zone];
	copyTimeline.threshold = [self.threshold copyWithZone: zone];
	...
	copyTimeline.animationLimit = [self.animationLimit copyWithZone: zone];
	copyTimeline.turboThreshold = [self.turboThreshold copyWithZone: zone];
	...
	copyTimeline.step = [self.step copyWithZone: zone];
	copyTimeline.getExtremesFromAll = [self.getExtremesFromAll copyWithZone: zone];
	...
	copyTimeline.zones = [self.zones copyWithZone: zone];
	copyTimeline.pointIntervalUnit = [self.pointIntervalUnit copyWithZone: zone];
	...
	copyTimeline.zoneAxis = [self.zoneAxis copyWithZone: zone];
	copyTimeline.className = [self.className copyWithZone: zone];
	copyTimeline.pointStart = [self.pointStart copyWithZone: zone];
	copyTimeline.connectEnds = [self.connectEnds copyWithZone: zone];
	copyTimeline.boostThreshold = [self.boostThreshold copyWithZone: zone];
	return copyTimeline;
}
