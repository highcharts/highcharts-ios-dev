...
-(id)copyWithZone:(NSZone *)zone {
	...
	HISpeed *copySpeed = [[HISpeed allocWithZone: zone] init];
	copySpeed.mapFunction = [self.mapFunction copyWithZone: zone];
	copySpeed.min = [self.min copyWithZone: zone];
	copySpeed.max = [self.max copyWithZone: zone];
	copySpeed.within = [self.within copyWithZone: zone];
	copySpeed.value = [self.value copyWithZone: zone];
	copySpeed.mapTo = [self.mapTo copyWithZone: zone];
	return copySpeed;
}
