...
#import "HISeriesNetworkDataLabelsOptionsObject.h"

@implementation HISeriesNetworkDataLabelsOptionsObject
...
-(id)copyWithZone:(NSZone *)zone {
	...
	HISeriesNetworkDataLabelsOptionsObject *copySeriesNetworkDataLabelsOptionsObject = [[HISeriesNetworkDataLabelsOptionsObject allocWithZone: zone] init];
	copySeriesNetworkDataLabelsOptionsObject.format = [self.format copyWithZone: zone];
	copySeriesNetworkDataLabelsOptionsObject.formatter = [self.formatter copyWithZone: zone];
	copySeriesNetworkDataLabelsOptionsObject.linkFormat = [self.linkFormat copyWithZone: zone];
	copySeriesNetworkDataLabelsOptionsObject.linkFormatter = [self.linkFormatter copyWithZone: zone];
	copySeriesNetworkDataLabelsOptionsObject.linkTextPath = [self.linkTextPath copyWithZone: zone];
	return copySeriesNetworkDataLabelsOptionsObject;
}
