...
-(NSDictionary *)getParams
{
	...
	if (self.linkFormatter) {
		params[@"linkFormatter"] = self.linkFormatter;
	}
	if (self.yHigh) {
...
-(void)setLinkFormatter:(id)linkFormatter {
	id oldValue = _linkFormatter;
	_linkFormatter = linkFormatter;
	[self updateNSObject:oldValue newValue:linkFormatter propertyName:@"linkFormatter"];
}
