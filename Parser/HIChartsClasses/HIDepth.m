...
-(id)copyWithZone:(NSZone *)zone {
	...
	HIDepth *copyDepth = [[HIDepth allocWithZone: zone] init];
	copyDepth.mapFunction = [self.mapFunction copyWithZone: zone];
	copyDepth.min = [self.min copyWithZone: zone];
	copyDepth.max = [self.max copyWithZone: zone];
	copyDepth.within = [self.within copyWithZone: zone];
	copyDepth.value = [self.value copyWithZone: zone];
	copyDepth.mapTo = [self.mapTo copyWithZone: zone];
	return copyDepth;
}
