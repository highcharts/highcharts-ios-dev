...
-(id)copyWithZone:(NSZone *)zone {
	...
	copyHistogram.data = [self.data copyWithZone: zone];
	...
	copyHistogram.linecap = [self.linecap copyWithZone: zone];
	...
	copyHistogram.pointInterval = [self.pointInterval copyWithZone: zone];
	...
	copyHistogram.marker = [self.marker copyWithZone: zone];
	...
	copyHistogram.connectNulls = [self.connectNulls copyWithZone: zone];
	...
	copyHistogram.stacking = [self.stacking copyWithZone: zone];
	...
	copyHistogram.step = [self.step copyWithZone: zone];
	...
	copyHistogram.pointIntervalUnit = [self.pointIntervalUnit copyWithZone: zone];
	copyHistogram.lineWidth = [self.lineWidth copyWithZone: zone];
	...
	copyHistogram.connectEnds = [self.connectEnds copyWithZone: zone];
	copyHistogram.boostThreshold = [self.boostThreshold copyWithZone: zone];
