...
-(id)copyWithZone:(NSZone *)zone {
	...
	copyVariablepie.stack = [self.stack copyWithZone: zone];
	copyVariablepie.type = [self.type copyWithZone: zone];
	copyVariablepie.xAxis = [self.xAxis copyWithZone: zone];
	copyVariablepie.yAxis = [self.yAxis copyWithZone: zone];
	...
	copyVariablepie.negativeColor = [self.negativeColor copyWithZone: zone];
	copyVariablepie.pointInterval = [self.pointInterval copyWithZone: zone];
	copyVariablepie.cropThreshold = [self.cropThreshold copyWithZone: zone];
	copyVariablepie.colorKey = [self.colorKey copyWithZone: zone];
	copyVariablepie.softThreshold = [self.softThreshold copyWithZone: zone];
	copyVariablepie.dragDrop = [self.dragDrop copyWithZone: zone];
	copyVariablepie.dataSorting = [self.dataSorting copyWithZone: zone];
	copyVariablepie.marker = [self.marker copyWithZone: zone];
	...
	copyVariablepie.dashStyle = [self.dashStyle copyWithZone: zone];
	copyVariablepie.pointPlacement = [self.pointPlacement copyWithZone: zone];
	copyVariablepie.connectNulls = [self.connectNulls copyWithZone: zone];
	...
	copyVariablepie.stacking = [self.stacking copyWithZone: zone];
	copyVariablepie.animation = [self.animation copyWithZone: zone];
	copyVariablepie.findNearestPointBy = [self.findNearestPointBy copyWithZone: zone];
	copyVariablepie.relativeXValue = [self.relativeXValue copyWithZone: zone];
	copyVariablepie.threshold = [self.threshold copyWithZone: zone];
	...
	copyVariablepie.animationLimit = [self.animationLimit copyWithZone: zone];
	copyVariablepie.turboThreshold = [self.turboThreshold copyWithZone: zone];
	...
	copyVariablepie.step = [self.step copyWithZone: zone];
	copyVariablepie.getExtremesFromAll = [self.getExtremesFromAll copyWithZone: zone];
	...
	copyVariablepie.zones = [self.zones copyWithZone: zone];
	copyVariablepie.pointIntervalUnit = [self.pointIntervalUnit copyWithZone: zone];
	copyVariablepie.lineWidth = [self.lineWidth copyWithZone: zone];
	...
	copyVariablepie.zoneAxis = [self.zoneAxis copyWithZone: zone];
	copyVariablepie.className = [self.className copyWithZone: zone];
	copyVariablepie.pointStart = [self.pointStart copyWithZone: zone];
	copyVariablepie.connectEnds = [self.connectEnds copyWithZone: zone];
	copyVariablepie.boostThreshold = [self.boostThreshold copyWithZone: zone];
