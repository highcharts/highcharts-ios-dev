...
@property(nonatomic, readwrite) NSString *newDataAnnounce;
@property(nonatomic, readwrite) NSString *newSeriesAnnounceMultiple;
@property(nonatomic, readwrite) NSString *newSeriesAnnounceSingle;
@property(nonatomic, readwrite) NSString *newPointAnnounceMultiple;
@property(nonatomic, readwrite) NSString *newPointAnnounceSingle;
/**
