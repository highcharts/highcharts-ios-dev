...
* demo: https://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/bubble-symbol/ : Bubble chart with various symbols
https://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-marker-symbol/ : General chart with predefined, graphic and custom markers
* accepted values: ["circle", "square", "diamond", "triangle",             "triangle-down"]
* default: null
*/
